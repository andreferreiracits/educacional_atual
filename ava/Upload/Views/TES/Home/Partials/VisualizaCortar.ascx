    ...
    %>
        ...
        <div id="img_padrao" class="imageBox" style="background-image: url(<%=strImg%>) ;background-size:100%; background-position:0 ">
            <div class="thumbBox" id="thumbBox" data-img="<%=strImg%>" >
                <!-- <img src="<%=ViewData["srcImagemCompleta"] %>" id="imagem_crop" alt="<%=item.strNome %>"/> -->
        ...
        <div>
            <div class="combo_recortar" style="display:none">
                ...
                <div class="cortar_cancelar" id="cortar_cancelar" >
                    <a href="javascript:void(0);" id="btn_concluir"  class="btn_cinza left recortar_imagem">Salvar</a>
                    <a  id="btn_cancelarGeral" onclick="cancela()"  class="btn_cinza left cancela_recorte">Cancelar</a>                    

                </div>
                <div id="manipulationClass"  class="action" style="display:none">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        console.log('teste entrou no init crop');
        ...
        function criaThumb(imgBase64, callback){
            ...
            img.onload = function () {
                ...
                var retBase64 = canvas.toDataURL();
                callback(retBase64);
            }
        }
