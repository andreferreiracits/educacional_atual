"use strict"
angular.module('Participantes').directive('galeriaParticipantes', function () {
    return {
        restrict: 'E',
        scope: {
            objEdicao : "=objEdicao",
        ...
        templateUrl: function (elem, attrs) {
            ...
            return '/AVA/Projetos/Scripts/App/Diretiva/Participantes/galeria-participantes.html';
        },
    };
});

angular.module('Participantes').controller('controleParticipantes', ["$http", "$scope", "$element", "$attrs", "$compile", "$timeout", "$filter", "projetoMapa", function ($http, $scope, $element, $attrs, $compile, $timeout, $filter, projetoMapa) {
    $scope.pagina = 1;
