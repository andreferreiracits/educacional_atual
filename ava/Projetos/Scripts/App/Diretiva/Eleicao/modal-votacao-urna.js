...
angular.module('Etapa').controller('ctrlModalVotacao', ['$scope', '$filter', '$log', '$modalInstance', '$http', '$timeout', '$interval', 'constantes', 'projetoTools', 'linkTarefa', function ($scope, $filter, $log, $modalInstance, $http, $timeout, $interval, constantes, projetoTools, linkTarefa) {
    var self = this;
    var initApi = true;
    $scope.bolCarregando = true;
    $scope.linkTarefa = linkTarefa;
