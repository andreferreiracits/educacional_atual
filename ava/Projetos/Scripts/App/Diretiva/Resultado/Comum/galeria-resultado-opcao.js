"use strict"
angular.module('resultado').directive('galeriaResultadoOpcao', function () {
    return {
        restrict: 'E',
        templateUrl: '/AVA/Projetos/Scripts/App/Diretiva/Resultado/Comum/galeria-resultado-opcao.html',
        scope: {
            objEdicao: "=objEdicao",
            objEtapa: "=objEtapa",
        ...
        controller: ['$http', '$scope', '$timeout', '$filter', '$location', function ($http, $scope, $timeout, $filter, $location) {
            ...
            this.buscarGaleriaResultado = function (bolNaoMudaAba) {
                ...
                if(!$scope.loadingBuscarGeral){
                    ...
                    $http.post('/AVA/Projetos/Servico/GetResultadoEnvioPorIdProjetoEdicaoEtapaOpcao',
                    {
                        ...
                        if(data.TotalEnvios){
                            ...
                            $scope.totalEnviosFiltrado = data.TotalEnvios;
                        }
                        //popula os envios
            ...
            this.requestEnvioPaginado = function(_idEstado,_idEscola,_idTurma,_bolProxPagina){
                ...
                var path = "/AVA/Projetos/Servico/GetResultadoEnvioPaginadoPorEdicaoEtapaOpcao/";
                var parametros = {
                    idProjeto: $scope.objEdicao.Projeto.Id,
                    idEdicao: $scope.objEdicao.Id, 
                    idEtapa: $scope.paramsMateriais.idEtapaParam,
