"use strict"
angular.module('Etapa').directive('etapaFormulario', function () {
    return {
        restrict: 'E',
        //replace: true,
        scope: {
        ...
        templateUrl: '/AVA/Projetos/Scripts/App/Diretiva/Etapa/etapa-formulario.html'
    };
});


angular.module('Etapa').controller("etapaFormularioCtrl", ['$http', '$scope', '$rootScope', 'perfilUsuario', '$timeout', 'projetoTools', function ($http, $scope, $rootScope, servicoUsuario, $timeout, projetoTools) {
