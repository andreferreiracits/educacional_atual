"use strict"
angular.module('Inscricao.mista').directive('listaEquipe', function () {
    return {
        restrict: 'E',
        templateUrl: '/AVA/Projetos/Scripts/App/Diretiva/Inscricao/clube/lista-equipe.html',
        scope: {
            edicao: "=edicao",
