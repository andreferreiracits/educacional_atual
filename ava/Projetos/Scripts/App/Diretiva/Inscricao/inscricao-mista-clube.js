...
angular.module('Inscricao.mista').directive('inscricaoMistaClube', function () {
    return {
        restrict: 'E',
        templateUrl: '/AVA/Projetos/Scripts/App/Diretiva/Inscricao/inscricao-mista-clube.html',
        scope: {
            usuario: "=usuario",
            edicao: "=edicao",
