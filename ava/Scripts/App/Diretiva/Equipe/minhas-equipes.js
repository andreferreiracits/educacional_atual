"use strict"
angular.module('Equipe').directive('minhasEquipes', function () {
    return {
        restrict: 'E',
        scope: {
            edicao: '=edicao',
        ...
        templateUrl: '/AVA/Projetos/Scripts/App/Diretiva/Equipe/minhas-equipes.html',
        controller: ['$http', '$scope', '$timeout', function ($http, $scope, $timeout) {
            ...
            this.getDescricaoSituacao = function(situacao){
                var strDescricao = '';
                
                if(situacao.Id==7){
                    strDescricao = 'Enviado pelo aluno';
                }
                else{
                    strDescricao = situacao.Descricao;
                }
                return strDescricao;
            };
                    ...
                    for (var i = 0; i < $scope.equipes.length; i++) {
                        if ($scope.equipes[i].Id === intFiltroEquipe) {
                            ...
                            $http({
                                ...
                                //_self.detalheEquipe.Alunos = data.alunos;
            ...
            this.carregaConteudo = function() {
                $http({
                    ...
                    url: '/AVA/Projetos/Servico/GetMeusEnviosEquipeModeracaoPaginado/',
                    method: 'POST',
                    params: {
        ...
        controllerAs: 'ctrlMinhasEquipes'
    };
});