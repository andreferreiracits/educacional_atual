...
angular.module("resultado")
.controller('PrimeiraTemporada2018Ctrl',
["$http", "$scope", "$timeout", "$interval", "$filter", "$location", "$state", function ($http, $scope, $timeout, $interval, $filter, $location, $state) {
    ...
    $scope.$on("$includeContentLoaded", function (event, templateName) {        
        //if (templateName == '/cp/projetos/template/2017/feiravirtualdasciencias/vencedores.html') {
        if (templateName == '/cp/projetos/template/2018/primeiratemporada/vencedores2222.html') {
