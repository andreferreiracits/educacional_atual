...
angular.module("resultado").controller('ResultadoParquesePracas2018Ctrl', ["$http", "$rootScope", "$scope", "$timeout", "$filter", "$location", "$state", "$modal", "projetoTools", "constantes", function ($http, $rootScope, $scope, $timeout, $filter, $location, $state, $modal, projetoTools, constantes) {
    var self = this;
