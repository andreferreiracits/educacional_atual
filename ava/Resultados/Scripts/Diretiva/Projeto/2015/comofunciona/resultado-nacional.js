    ...
    $stateProvider
        .state('principal', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Projeto/2015/comofunciona/_principal.html",
                    controller: "ComoFuncionaPrincipal2015Ctrl"
                }
            }
        })
        .state('almanaque', {
        ...
        .state('jogo', {
            ...
            views:
            {
                "main":
                {
                    ...
                    controller: "ComoFuncionaJogo2015Ctrl"
                }
            }
        })
        .state('museu', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Projeto/2015/comofunciona/_museu.html",
                    controller: "ComoFuncionaMuseu2015Ctrl"
                }
            }
        })
        .state('lugares', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Projeto/2015/comofunciona/_lugares.html",
                    controller: "ComoFuncionaLugares2015Ctrl"
                }
            }
        })
        .state('eventos', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Projeto/2015/comofunciona/_eventos.html",
                    controller: "ComoFuncionaEventos2015Ctrl"
                }
            }
        });
...
angular.module("resultado")
.controller('ComoFunciona2015Ctrl',
