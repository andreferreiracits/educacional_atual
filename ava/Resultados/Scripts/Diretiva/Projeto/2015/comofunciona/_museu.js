...
angular.module("resultado").controller('ComoFuncionaMuseu2015Ctrl', ["$http", "$scope", "$timeout", "$filter", "$location","projetoMapa", function ($http, $scope, $timeout, $filter, $location, projetoMapa) {
    var _self = this;
