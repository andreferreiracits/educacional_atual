...
angular.module("resultado").controller('ComoFuncionaMuseu2016Ctrl', ["$http", "$scope", "$timeout", "$filter", "$location","projetoMapa", function ($http, $scope, $timeout, $filter, $location, projetoMapa) {
    var _self = this;
        ...
        $timeout(function(){
            ...
            if(true){
                ...
                var parametros = {
                    ...
                    intDestaque: 0,
                    intEtapaRelativa: 0,
                    idCategoria: $scope.categoriasEtapa1[0].Id,
                    termoBusca: ''
                };
