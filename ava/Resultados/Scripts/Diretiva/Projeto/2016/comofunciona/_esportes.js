...
angular.module("resultado").controller('ComoFuncionaEsportes2016Ctrl', ["$http", "$scope", "$timeout", "$filter", "$location","projetoMapa", function ($http, $scope, $timeout, $filter, $location, projetoMapa) {
    var _self = this;
        ...
        $timeout(function(){
            ...
            if(true){
                ...
                var parametros = {
                    ...
                    intDestaque: 0,
                    intEtapaRelativa: 0,
                    idCategoria: $scope.categoriasEtapa1[3].Id,
                    termoBusca: ''
                };
                ...
                $http({
                    ...
                    if (data) if (data instanceof Object) {
                        ...
                        if(data.TotalEnvios){
                            $scope.TotalEnvios = data.TotalEnvios;
                        }
                            //popula os envios
