...
angular.module('resultado').directive('galeriaCarousel', function () {
    return {
        ...
        templateUrl: function (element, attrs) {
            return '/AVA/Resultados/Scripts/Diretiva/Projeto/2016/comofunciona/galeria-carousel.html';
        },
            ...
            scope.render = function (valor) {
                ...
                if (scope.envios) if (scope.envios instanceof Array) if (scope.envios.length >= 0) {
                    ...
                    for (var item in scope.envios) {
                        ...
                        tmplt += '	<a href="/AVA/Projetos/2016/' + scope.envios[item].Etapa.Edicao.Link + '/Etapas/' + scope.envios[item].Etapa.Link + '/' + scope.envios[item].MensagemRapida.StrEncryptIdMensagem + '">';
