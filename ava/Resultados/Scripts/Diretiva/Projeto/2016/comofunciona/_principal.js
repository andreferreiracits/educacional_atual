...
angular.module("resultado").controller('ComoFuncionaPrincipal2016Ctrl', ["$stateParams", "$http", "$scope", "$timeout", "$filter", "$location", "$state", '$modal', function ($stateParams, $http, $scope, $timeout, $filter, $location, $state, $modal) {
    var self = this;
    var mgr;
