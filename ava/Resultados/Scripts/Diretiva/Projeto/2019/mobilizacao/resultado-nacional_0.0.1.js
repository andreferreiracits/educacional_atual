...
angular.module("resultado").controller('ResultadoMobilizacao2019Ctrl', ["$http", "$rootScope", "$scope", "$timeout", "$filter", "$location", "$state", "$modal", "projetoTools", "constantes", function ($http, $rootScope, $scope, $timeout, $filter, $location, $state, $modal, projetoTools, constantes) {
    var self = this;
