    ...
    $stateProvider
        .state('principal', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Clube/sustentabilidade/_principal.html",
                    controller: "SustentabilidadePrincipalCtrl"
                }
            }
        })
        .state('jogo', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Clube/sustentabilidade/_jogo.html",
                    controller: "SustentabilidadeJogoCtrl"
                }
            }
        })
        .state('almanaque', {
            ...
            views:
            {
                "main":
                {
                    templateUrl: "/AVA/Resultados/Scripts/Diretiva/Clube/sustentabilidade/Desafios",
...
angular.module("resultado")
.controller('SustentabilidadeCtrl',
["$http", "$scope", "$timeout", "$filter", "$location", "$state", function ($http, $scope, $timeout, $filter, $location, $state) {
    ...
    this.init = function () {
        ...
        var parametros = {
            ...
            idEtapa: $scope.resultado.JsonConfig.substring(9, 11)
        };
