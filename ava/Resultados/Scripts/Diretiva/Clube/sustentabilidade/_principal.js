...
angular.module("resultado").controller('SustentabilidadePrincipalCtrl', ["$stateParams", "$http", "$scope", "$timeout", "$filter", "$location", "$state", '$modal', function ($stateParams, $http, $scope, $timeout, $filter, $location, $state, $modal) {
    var self = this;
    var mgr;
    ...
    $scope.openOverlay = function () {
        var modalInstance = $modal.open({
            templateUrl: '/AVA/Resultados/Scripts/Diretiva/Projeto/Clube/Sustentabilidade/_jogo.html',
