...
<div class="mp_edt_denuncia" id="mp_edt_denuncia" style="font-family:arial;">	
    <form id="frmDenuncia" name="frmDenuncia">
    	<div class="" style="height:27px;padding: 13px 0px 0px 10px;border-bottom:solid 1px #D2D2D2;background-position:0 -5px; "><h2>Denúncia de conteúdo impróprio</h2></div>
        <div class="">
