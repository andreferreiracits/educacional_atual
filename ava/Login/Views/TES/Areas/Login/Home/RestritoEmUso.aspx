		        ...
		        <!-- CONTEÚDO -->
					        ...
					        <div>
						        ...
						        Você tentou acessar uma área restrita. 
							        ...
							        <div style="padding:20px" align="center"><input name="button" type="button" class="botao" onClick="window.location.href='<%=Url.Action("Login", "Home", new { area = "Login" }) %>?ReturnUrl=<%=ReturnUrl %>';" value="Faça seu login aqui"></div>
