			...
			<!-- Pode haver multiplos footers e headers em cada pagina -->
				<div id="wrapper">
						...
						<nav id="main-nav">
							<div>
                                ...
                                <%}
                                 ...
                                 { %>
                                 <h1 class="blokletters">Portf&oacute;lio de <%= ViewData["strLogin"]%></h1>
                                <%} %>
                    ...
                    <section class="portfolio" id="listagem_itens">
                                    ...
                                    foreach (Portfolio.Model.Materiais MaterialDoUsuario in Model)
                                    {
                                        ...
                                        if (contador == 1)
                                        {
                                            ...
                                            %>
                                              <div class="itens">
                                                <ul class="acoes">
					                                <li class="comentar"><a href="javascript:void(0);" class="comentarios_modal resumoComentario" ident="<%=MaterialDoUsuario.idProducaoUsuario%>"></a></li>	
                                                    <%if (MaterialDoUsuario.jaCurtiu)
                                                        {  %>
					                                    <li class="ativo gostar Gostar<%=MaterialDoUsuario.idProducaoUsuario%>" idProducaoUsuario="<%=MaterialDoUsuario.idProducaoUsuario%>"><a href="javascript:void(0);"></a></li>	
                                                    <%}
                                                        else
                                                        { %>
                                                        <li class="gostar Gostar<%=MaterialDoUsuario.idProducaoUsuario%>" idProducaoUsuario="<%=MaterialDoUsuario.idProducaoUsuario%>"><a href="javascript:void(0);"></a></li>	
                                                    <%} %>
				                                </ul>
				                                <div class="conteudo_geral">
					                                <span class="porftolio_top">
                                                        <a href="<%=MaterialDoUsuario.strLink%>" target="_blank">
						                                <img src="/AVA<%=MaterialDoUsuario.strThumb%>" width="218" height="142" alt="<%=MaterialDoUsuario.strProducao%>"/>
                                                        </a>
					                                </span>
				                                ...
				                                <a class="resumo curtir_modal" href="javascript:abreListaCurtidas(<%=MaterialDoUsuario.idProducaoUsuario%>);" ident="<%=MaterialDoUsuario.idProducaoUsuario%>">
                                                <%if (MaterialDoUsuario.jaCurtiu)
                                                    {  %>
				                                ...
				                                <a href="javascript:void(0);" class="resumo comentarios_modal resumoComentario" ident="<%=MaterialDoUsuario.idProducaoUsuario%>">
                                                ...
                                                if (MaterialDoUsuario.podeDespublicar)
                                                {
                                                    ...
                                                    {
                                                        %>                               
    		                                                <a class="publicar" idProducaoUsuario="<%=MaterialDoUsuario.idProducaoUsuario%>" href="javascript:void(0);"></a>
                                                        <%
                                                    }
                                                    else
                                                    { 
                                                        %>
                                                            <a class="publicar despublicar" idProducaoUsuario="<%=MaterialDoUsuario.idProducaoUsuario%>" href="javascript:void(0);"></a>
                                                        <%
                                                    }
                                                }
                                                %>
                        ...
                        for (int i = (int)ViewData["anoVigente"]-2; i >= 2008;i--){ %>
                                   <span anoCarregado="<%=i %>" id="Span2" class="blocoAno itens tipo_ano2 anoPortfolio<%=i %>"><strong class="blokletters"><%=i %></strong></span>
                                   <span id="materiais<%=i %>">
                                       <span class="itens carregar_proximo_ano anoPortfolio<%=i %> carregar<%=i %>" intAnoCarregar="<%=i %>">
						                   <a href="javascript:void(0);">Carregar materiais de <%=i %></a>
					                   </span>
                                   </span>
                                <%}%>	
...
<script type="text/javascript">
                            ...
                            success: function (data) {
                                ...
                                if(data.Retorno[0].Erro == 1){
                                    ...
                                    if(data.Retorno[1].Comentario.podeDeletar == 'true'){
                                        RetornoComentario += "<a href=\"javascript:void(0);\" class=\"excluir_comentario\" onclick=\"javascript:deletarComentario('"+ data.Retorno[1].Comentario.idFerramentaMensagem +"','"+ data.Retorno[1].Comentario.idProducaoUsuario +"');\"></a>";
                                    }else{
                                    ...
                                    $('.semComentarios').hide();
                                    $('#comentariosAjax').append(RetornoComentario);
                    ...
                    success: function (data) {
                         ...
                         if (data.Retorno[0].erro == 1) {
                            ...
                            for (i = 1; i < data.Retorno.length; i++) {
                                ...
                                RetornoHtml += '                <img src="/AVA' + data.Retorno[i].Portfolio.strThumb + '" width="218" height="142" alt="' + data.Retorno[i].Portfolio.strProducao + '"/>';
                                RetornoHtml += '            </a>';
                                RetornoHtml += '        </span>';
                                RetornoHtml += '        <a href="' + data.Retorno[i].Portfolio.strLink + '" target="_blank">';
                    ...
                    success: function (data) {
                         ...
                         if (data.Retorno[0].erro == 1) {
                            ...
                            for (i = 1; i < data.Retorno.length; i++) {
                                ...
                                RetornoHtml += '        </a>';
                                RetornoHtml += '    </div>';
                                RetornoHtml += '    <a class="resumo curtir_modal" href="javascript:abreListaCurtidas(\'' + data.Retorno[i].Portfolio.idProducaoUsuario +'\');"'+ data.Retorno[i].Portfolio.idProducaoUsuario +'\");" ident="'+ data.Retorno[i].Portfolio.idProducaoUsuario +'">';
                                RetornoHtml += '        <span class="resumo_curtir resumoCurtir'+ data.Retorno[i].Portfolio.idProducaoUsuario +'" ident="'+ data.Retorno[i].Portfolio.idProducaoUsuario +'">'+ data.Retorno[i].Portfolio.quantidadeCurtidas +'</span>';
                                RetornoHtml += '        <!--<span class="resumo_share">15</span>-->';
                                RetornoHtml += '    </a>';
                                RetornoHtml += '    <a href="javascript:void(0);" class="resumo comentarios_modal resumoComentario" ident="'+ data.Retorno[i].Portfolio.idProducaoUsuario +'">';
                                RetornoHtml += '	    <span class="resumo_comentario resumo_comentario'+ data.Retorno[i].Portfolio.idProducaoUsuario +'">'+ data.Retorno[i].Portfolio.quantidadeComentarios +'</span>';
                                RetornoHtml += '    </a>';
                                if(podeDespublicar){
                                    RetornoHtml += '    <a class="publicar '+classeAtivo+'" idProducaoUsuario="' + data.Retorno[i].Portfolio.idProducaoUsuario + '" href="javascript:void(0);"></a>';
    ...
    $("#listagem_itens").on('click','.acoes .gostar',function(){
        var botaoClicado            = $(this);
        var idProducaoUsuario       = $(this).attr('idProducaoUsuario');
        var bolCurtido              = false;
...
/*    function CarregarAno(ano){
    ...
    */
    function deletarComentario(idFerramentaMensagem,idProducaoUsuario){
