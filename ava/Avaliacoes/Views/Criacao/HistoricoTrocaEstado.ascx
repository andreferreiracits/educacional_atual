<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IList<ProvaColegiada.Models.Exam.Fluxo.ProvaHistoricoEstado>>" %>
...
<% 
    bool corsim = false;
    foreach (ProvaHistoricoEstado historico in Model)
   {
        %>
