...
<body>
	...
	<%  using (Html.BeginForm("SalvarImagemAnexo", (string)ViewData["Action"], FormMethod.Post, new { @id = "frmSalvarImagem", @enctype = "multipart/form-data" }))
		{ %>
			<div id="anexar">
				...
				<input type="hidden" id="txtIdObjeto" name="txtIdObjeto" value="<%=ViewData["Id"] %>" />
