...
<%
    using (Html.BeginForm("CarregarClassificacaoQuestao", "ProvinhaBrasil", FormMethod.Post, new { @id = "frmClassificacaoProvinhaBrasil" }))
		

	{ %>
	<%= Html.Hidden("totalPorPagina", 10, new { @id = "totalPorPaginaProvinhaBrasil" })%>
<table id="tblListProvinhaBrasil" class="tabela tamQuestao  %>" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
