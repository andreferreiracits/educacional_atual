...
<%
	using (Html.BeginForm("CarregarClassificacaoQuestao", "AreaAssunto", FormMethod.Post, new { @id = "frmClassificacaoAssunto" }))
	{ %>
	<%= Html.Hidden("totalPorPagina", 10, new { @id = "totalPorPaginaAssunto" })%>
<table id="tblListAssunto" class="tabela tamQuestao" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
