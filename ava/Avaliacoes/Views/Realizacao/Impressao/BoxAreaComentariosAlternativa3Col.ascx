...
<% if (Model.ShowBtnDica != ComentarioRealizadaView.TipoShow.hide)
    {%>
    <tr>
        <td class="textoComentario" colspan="3">
        <p class="tituloComentario">*Dica para a alternativa:</p>
...
<% if (!String.IsNullOrWhiteSpace(Model.ContentAluno))
    ...
    <tr>
        <td class="textoComentario" colspan="3">
        <p class="tituloComentario">*Comentários do professor sobre a alternativa:</p>
        <%=Model.ContentAluno%>
        </td>
    </tr>
<% } %>
