		...
		{ %>
						<div class="areaConfiguracoesClassificacao">
							...
							<div class="linhaImpar">
								<label class="questao" for="slcOrigem">Instituição:</label>
								<span class="SEC02511_texto">
									<%= Html.DropDownList("slcOrigem", (IEnumerable<SelectListItem>) Model.Origem, new { @id = "slcOrigem", @class = "slcDificuldade slcBig" })%>
								</span>
							</div>
						
							<div class="linhaPar">
								<label for="slcDificuldade" class="questao">Grau de dificuldade:</label>
								<span class="SEC02511_texto">
									<%= Html.DropDownList("slcDificuldade", (IEnumerable<SelectListItem>) Model.GrauDificuldade, new { @id = "slcDificuldade", @class = "slcDificuldade" })%>
								</span>
							</div>
