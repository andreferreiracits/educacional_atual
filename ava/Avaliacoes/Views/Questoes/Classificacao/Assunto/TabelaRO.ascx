...
<table class="tabela tamQuestao <%=Model.hideTipoClassificacao(EnumTipoClassificacao.Assunto) %>" cellpadding="0" cellspacing="0">
    <thead>
        <tr>
    ...
    <tbody>
    <%
        List<AbstractClassificacao> lista = Model.Lista.listByTipo(EnumTipoClassificacao.Assunto);
        foreach (Assunto assunto in lista)
            {
            %>
                    <tr>
                        <td width="50%">
