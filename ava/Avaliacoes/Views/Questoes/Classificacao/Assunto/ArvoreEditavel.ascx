...
<%
    ...
    {
        NoAssuntoVO no = (NoAssuntoVO)noV;//  class="editavel pertence"
%>
    <li>
        ...
        <% 
            if (no.TemFilhos)
                Html.RenderPartial("../Questoes/Classificacao/Assunto/ArvoreEditavel", new Arvore<NoVO>(no.Filhos, Model.Editavel, Model.Selecionavel, no.Id));
        %>
