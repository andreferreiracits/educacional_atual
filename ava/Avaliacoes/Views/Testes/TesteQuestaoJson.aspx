        ...
        $(document).ready(function () {
            ...
            $('form').submit(function (ev) {
                ...
                if ($(this).find("input[name='tipoTeste'][value=1]:checked").length >= 1) {
                    bolTeste = true;
                    url = caminhoBase + "/QuestoesJson/QuestaoDecript";
                }
...
<body>
    ...
    <div>
    <%  
        using (Html.BeginForm("Questao", "QuestoesJson", FormMethod.Post, new { @id = "frmQuestao1" }))
        {%>
...
<%  
    using (Html.BeginForm("Questao", "QuestoesJson", FormMethod.Post, new { @id = "frmQuestao2" }))
        {%>
...
%>
<%  
    using (Html.BeginForm("Questao", "QuestoesJson", FormMethod.Post, new { @id = "frmQuestao3" }))
        {%>
