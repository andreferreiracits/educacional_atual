...
<asp:Content ID="TitleArea" ContentPlaceHolderID="TitleArea" runat="server">
	<script src="<%= Page.ResolveUrl("~/Scripts/view/aplicacao.js") %>" type="text/javascript"></script>
	...
	<div id="conteudo">
		<div class="caixa">
			...
			<div id="caixaConteudo" class="caixaConteudo">
				...
				<%= Html.ActionLink("Cadastrar nova aplicação", "Criar", "Aplicacao", new { @id = "addAplicacao", @class = "btn" })%>
				
				<div id="alerta" class="mensagem comBotao"></div>
				
			<!-- #region Formulário da Tabela de Aplicacao -->
				<% using (Html.BeginForm("CarregarAplicacaoCadastro", "Aplicacao", FormMethod.Post, new { @id = "frmTabela", @class = "tbl" }))
				{ %>
					...
					<div class="funcao">
						...
						<div id="filtro" class="slc">
							...
							<div class="opcoes filtro">
								<a class="fechar right" href="#fechar">Fechar</a>
								<div class="frm">
									...
									<%= Html.TextBox("txtRealizacaoInicial", "", new { @id = "txtRealizacaoInicial", @size = 14, @maxlength = 20, @readonly = "readonly", @class = "txt txtData" })%>
									<span>a</span>
									<%= Html.TextBox("txtRealizacaoFinal", "", new { @id = "txtRealizacaoFinal", @size = 14, @maxlength = 20, @readonly = "readonly", @class = "txt txtData" })%>
