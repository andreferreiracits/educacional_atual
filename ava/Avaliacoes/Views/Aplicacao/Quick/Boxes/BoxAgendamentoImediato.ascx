<%@ Control Language="C#"  Inherits="System.Web.Mvc.ViewUserControl<ProvaColegiada.TabelaViews.AplicacaoView>" %>
    <div class="linhaPar">
        <div class="opcoes">
            <label class="<%=Model.AgendamentoDesabilitado %>"><input type="radio" name="rdoAgendamento" id="rdoAgendamentoNao" value="2" <%=Model.CheckSemAgendamento %> <%=Model.AgendamentoDisabled %>/> Inicio imediato após publicação.</label>
        </div>
    </div>
