...
<asp:Content ID="JsArea" ContentPlaceHolderID="JsArea" runat="server">
    <%=Html.BundleScript(Avaliacoes.Framework.Web.Bundle.Bundle.Tipo.Sem, "Scripts/view/aresponder-1.{0.0}.js")%>
...
<asp:Content ID="CssArea" ContentPlaceHolderID="CssArea" runat="server">
	<link href="<%= UtilView.Url("/Content/css/aResponder.css") %>" rel="stylesheet" type="text/css" />
...
<asp:Content ID="ContentArea" ContentPlaceHolderID="ContentArea" runat="server">
    ...
    <div id="conteudo">
	    <div class="caixa">
            ...
            <% using (Html.BeginForm("CarregarAplicacoes", "Aresponder", FormMethod.Post, new { @id = "frmTabela", @class = "tbl" }))
                    { %>
            ...
            <div id="AResponder">
                ...
                <div id="Corpo" class='Corpo'>
                    ...
                    <div id="colunaEsquerdaAResponder" class='colunaEsquerdaAResponder'>
                        ...
                        <div id="associarGrupoArsp" class='divAssociarGrupo'>
                            <div class="titdivAssociarGrupo"></div>
                            <div class="linhaDivAssociarGrupo"><input name="keyGerenciador"  maxlength="8" value=""/>
                                <div id="botaoOK" class="botaoOK"><span>OK</span></div>
                                <div id="botaoOkk" class="hide"></div>
                            </div>
                        </div>
                    </div>
                        <div id="colunaDireitaAResponder" class='colunaDireitaAResponder'>
                            ...
                            <div id="divFiltroAvancado">
                                        ...
                                        <a id="helpAresponder" class="btn sec_menuNavegacao" href="javascript:void(O)">?</a>
				            ...
				            <table id="tblAplicacoesUsuario" width="100%">
	                            <tbody></tbody>
                            </table>
                            </div>
                        </div>
