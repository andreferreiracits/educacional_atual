...
%>
        ...
        <tr class="<%=linha.CssTRStatusAberta %> <%=linha.CssRealizarAvaliaca%>" <%=linha.RealizarAvaliacao %>>
            <td>
            ...
            {
                        %>
                        <span class="tmhIcoAplic icoDataAgendado"></span><span>Período indeterminado</span>
                        <%
            }
                        %>
                        <span class="icoAgendador"></span><span> Agendado por: <b><%= linha.NomeAutor %></b></span>
                    </div>
                </div>
            </td>
