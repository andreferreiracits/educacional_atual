...
<div id="questoesDaProva" class="hide"><div class="texto">Questões inseridas na avaliacação:</div><span class="count">0</span> <a class="btn btnVerQuestoes" href="javascript:void(0)">ver questões »</a><a href="javascript:void(0)" id="helpQstProva" class="btn">?</a> </div>
