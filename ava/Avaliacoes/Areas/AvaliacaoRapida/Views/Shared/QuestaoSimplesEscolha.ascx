...
<form>
    ...
    <div id="areaRespostas" class="areaRespostas">
        <div class="divisaoTopicos">
            ...
            <div class="textoDivisao">Digite o texto de cada alternativa e marque qual é a correta.</div>
        </div>
    ...
    <div id="cxaAdicionarAlternativa" class="">
        <a class="btn btnAdicione"><span class="icoAdicionar"></span> adicionar alternativa</a>
    </div>
</form>