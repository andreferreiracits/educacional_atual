<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Avaliacaoes.Componentes.Relatorios.Models.Entidades.RelatorioAgendamentoPesquisaOpiniaoView>" %>
    ...
    <div class="areaConfiguracoesRelatorio">
        ...
        <div class="linhaImpar">
            ...
            <div class="dadosCriacao">
                    ...
                    <label><input name="Tipo" type="radio" value="<%=Avaliacoes.Servicos.Relatorios.Imp.TipoRelatorio.AgendamentoAvaliacao.Id%>" <%= Model.JaCadastrado ? "disabled=\"disabled\"" : "" %> > Avaliação</label>
                    <label><input name="Tipo" type="radio" value="<%=Avaliacoes.Servicos.Relatorios.Imp.TipoRelatorio.AgendamentoPesquisaOpiniao.Id%>" checked="checked">Pesquisa de Opinião</label>
            </div>
        </div>
