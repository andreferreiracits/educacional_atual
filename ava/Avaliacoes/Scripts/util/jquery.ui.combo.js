    ...
    $.widget("ui.combo", {
        ...
        _refreshValue: function () {
            ...
            link.click(function () {
                ...
                //Exibe apenas o conteudo da ultima combo clicada
                $(".ferramentas div.slc a.selecionado").each(function () {
                    var clicado = link.parent("div.slc");
                    var fechar  = $(this).parent("div.slc");

                    if (fechar && clicado.attr("id") != fechar.attr("id")) {
                        fechar.find("a.nome").trigger("click");
                    }
                });
