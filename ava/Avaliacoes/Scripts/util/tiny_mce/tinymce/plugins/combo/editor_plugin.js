...
(function() {
	...
	tinymce.create('tinymce.plugins.combo', {
		...
		init : function(ed, url) {
			...
			ed.addButton('combo', {title : 'Caixa de opções de texto', image: url+'/combo.gif', cmd : 'mceCombo'});
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('combo', n.nodeName == 'IMG' && isComboElm(n));
			});
	...
	// Register plugin
	tinymce.PluginManager.add('combo', tinymce.plugins.combo);
})();