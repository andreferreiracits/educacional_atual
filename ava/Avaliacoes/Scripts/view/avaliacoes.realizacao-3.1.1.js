    ...
    var methods = {
        ...
        realizar: function (options) {
            ...
            realizadorDAL.init(function(){
                ...
                realizadorDAL.Realizar($this.data('settings').idAplicacao,$this.data('settings').idProva, retornoRealizar);    
            });
        ...
        visualizar: function (options) {
            ...
            realizadorDAL.init(function(){
                ...
                realizadorDAL.Visualizar($this.data('settings').idAplicacao,$this.data('settings').idProva, retornoVisualizar); 
            });
