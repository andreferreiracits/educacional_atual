    ...
    var methods = {
        ...
        init: function (options) {
            ...
            var settings = {
                ...
                'mensagem': undefined, //new Mensagem($(this), 'boxMsg'),
                'confirm': undefined, //new Confirm($(this), 'boxMsg'),
            ...
            return this.each(function () {
                ...
                function endInserJS() {
                    ...
                    if (!$this.data('settings').mensagem) {
                        $this.data('settings').mensagem = new Mensagem($this, 'boxMsg');
                    }
                    if (!$this.data('settings').confirm) {
                        $this.data('settings').confirm = new Confirm($this, 'boxMsg');
                    }
        ...
        _quicknova: function () {
            ...
            var AA_Grupos, AA_Config, AA_Resumo;
            var boxShowQuestoes;
            var boxGerenciador;
            ...
            function retornoQuickNova(dados) {
                ...
                $this.find("#btnCancelarGrupos").attr('href', FUNCAO_VAZIA).click(cancelar);
                ...
                $this.find("#btnContinuarGrupos").attr('href', FUNCAO_VAZIA).click(salvarGrupos).hide();
            ...
            function abrirGrupos() {
                ...
                $this.find("#AA_btnCriarGrupos").click(function () {
            ...
            function retornoGerenciadorAbriuCriar() {
                ...
                $this.find("#btnSalvarGrupos").show();
            ...
            function retornoAbrirConfig(dados) {
                ...
                $this.find("#btnCancelarConfig").attr('href', FUNCAO_VAZIA).click(cancelar);
                ...
                $this.find("input#txtHoraRealizacaoInicio.habilitado, input#txtHoraRealizacaoFinal, input#txtHrCorrecao, input#txtHoraGabarito").timePicker().attr('readonly', 'readonly');
                ...
                $this.find("input#txtDataRealizacaoInicio.desabilitado, input#txtHoraRealizacaoInicio.desabilitado").attr('readonly', 'readonly');
            ...
            function validarCamposResumo() {
                ...
                if ($this.find("input#rdoAgendamentoSim").is(":checked")) {
                    if (($this.find("input#txtDataRealizacaoInicio").val().length == 0) || ($this.find("input#txtDataRealizacaoFinal").val().length == 0) || ($this.find("input#txtHoraRealizacaoInicio").val().length == 0) || ($this.find("input#txtHoraRealizacaoFinal").val().length == 0)) {
                        ...
                        var dados = mensagem.htmlTemplate(true, "Data Agendamento incompleta", 'alerta');
                ...
                if ($this.find("input#rdoCorrecaoData").is(":checked")) {
                    if (($this.find("input#txtDataCorrecao").val().length == 0) || ($this.find("input#txtHrCorrecao").val().length == 0)) {
                        var dados = mensagem.htmlTemplate(true, "Data Correção incompleta", 'alerta');
                        mensagem.exibir($(dados));
                        return false;
                    }
                }
                if ($this.find("input#rdoGabaritoData").is(":checked")) {
                    if (($this.find("input#txtDataGabarito").val().length == 0) || ($this.find("input#txtHoraGabarito").val().length == 0)) {
                        var dados = mensagem.htmlTemplate(true, "Data Gabarito incompleta", 'alerta');
                        mensagem.exibir($(dados));
                        return false;
                    }
                }
            ...
            function validarCamposConclusao() {
                ...
                if ($this.find("input#txtTituloAtividade").val().length == 0) {
                    var dados = mensagem.htmlTemplate(true, "Titulo atividade em branco", 'alerta');
                    mensagem.exibir($(dados));
                    return false;
                }
                /*
            ...
            function retornoAbrirResumo(dados) {
                ...
                $this.find("#btnCancelarResumo").attr('href', FUNCAO_VAZIA).click(cancelar);
