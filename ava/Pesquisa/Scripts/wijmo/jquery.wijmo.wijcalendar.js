    ...
    $.widget("wijmo.wijcalendar", {
        ...
        onDayClicked: function (e) {
            ...
            if (this.isPopupShowing()) {
                ...
                //alert(date);
                var dataf = this._formatDate("dd/MM/yyyy", date)
                var text = "/AVA/Agenda/Home/VerificaEventoData?data=" + dataf + "&idCategoria=" + idCategoria;
                //alert(text);
                var _e = e.currentTarget;
                $(_e).find('a').attr('rel', text);
                $(_e).find('a').attr('href', text);
        ...
        _getCellClassName: function (dayType, date, previewMode) {
            ...
            var $class = "";
            /*
            var dayBR = this._formatDate("dd/MM/yyyy", date);
			
			
            $.ajax({ 
            type:"POST", 
            url:'/AVA/Agenda/Home/VerificaEventoData/?data=' + dayBR,
            async: false, 
            ...
            */
            ...
            if ((dayType & wijDayType.gap)) {
                ...
                if ((dayType & wijDayType.custom)) {
                    cssCell += ' wijmo-wijcalendar-customday' + $class;
                }
            }
    ...
    wijMonthView.prototype = {
        ...
        _fillDayCell: function (hw, date, previewMode) {
            ...
            var o = this.calendar.options,
							...
							tooltip = this.calendar._formatDate(o.toolTipFormat || "dddd, dd MMMM yyyy", date),
							dayType = this._getDayType(date),
							dayBR = this.calendar._formatDate("dd/MM/yyyy", date),
            ...
            */
            ...
            $.ajax({ 
            type:"POST", 
            url:'/AVA/Agenda/Home/ContadorEventoData/?data=' + dayBR,
            async: false, 
            success:function(data) { 
            $total = data;
            } 
            ...
            */
            //************* ANA ***************							
            var urlAVA = "/AVA/Agenda/Home/VerificaEventoData?data=" + dayBR + "&idCategoria=" + idCategoria;
            ...
            hw.writeAttribute('dataBR', dayBR);

            hw.writeAttribute('class', css.cssCell + $class);
            ...
            if ((dayType & wijDayType.gap)) {
                ...
                if (custom && custom.content) {
                    ...
                    hw.writeBeginTag('a');
                    hw.writeAttribute('class', css.cssText + ' avaJCalendario');
                    hw.writeAttribute('href', escape(urlAVA));
                    hw.writeAttribute('rel', urlAVA);
                    hw.writeAttribute('ref', 'avaCalendario_' + dayBR);
        ...
        getHtml: function (tableOnly) {
            ...
            if (!tableOnly && !previewMode && this.showPreview) {
                ...
                hw.writeAttribute('href', '/AVA/Agenda/Home/VerificaEventoData');
                hw.writeAttribute('rel', '/AVA/Agenda/Home/VerificaEventoData');
            ...
            for (i = 0; i < o.dayRows; i++) {
                ...
                for (j = 0; j < o.dayCols; j++) {
                    //**********ANA ********/
                    var dayBR = this.calendar._formatDate("dd/MM/yyyy", date);
                    dataBR[m] = dayBR;
                    m++;
                    //**********ANA ********/
            ...
            //$("#descricaoDia_EventoAgenda").empty().html("<img src='../../Scripts/img/perfil/carregando.gif' border='0' />");
            var idCategoria = "";
            $("#formTemp").find(":checked").each(function () {
                //alert($(this).val());
                idCategoria = idCategoria + $(this).val() + ",";
