...
<div class="mp_edt_denuncia" id="mp_edt_denuncia" style="font-family:arial;">
	<form id="frmSuspensao" name="frmSuspensao">
    	<div class="" style="background: url(/imagens/templates/2010/tema_azul_claro_620.gif) no-repeat top left;height:27px;padding: 13px 0px 0px 10px;border-bottom:solid 1px #D2D2D2;background-position:0 -5px; "><h2>Suspender</h2></div>
        <div class="">
