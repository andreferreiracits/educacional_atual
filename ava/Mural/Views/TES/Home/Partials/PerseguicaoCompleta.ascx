...
<div class="ava_lightheader">
    ...
    <form target="_top" name="fFiltro">
        <input type="text" class="campo" value="Filtrar por nome" id="txtFiltroAva" name="strpc_topo">                         
    </form>
</div>
        ...
        {{each Result}}
            ...
            <div class="carteirinha" id="cart_${id}">
                <div class="in_cT">
                    ...
                    <a href="/AVA/Perfil/Home/Index/${strLogin}" ><img src="${strMiniFoto}" width="55" height="55" alt="${strNome}">${strNome}</a>                   
