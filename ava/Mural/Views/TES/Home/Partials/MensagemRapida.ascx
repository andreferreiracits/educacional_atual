...
<script type="text/javascript">
    ...
    $(function () {           
        ...
        $("#agendar").live('click', function () {
            console.log("botao agendar Ava/Mural/Views/TES/Home/Partials/MensagemRapida.ascx");
...
<div id="frmMensagemRapida">
    ...
    <section class="dialogo clearfix">
        ...
        <div class="dialogo_box actions_target">
            <textarea id="txtInput" class="dialogo_field  ph" autocomplete="off" cols="40" rows="1" placeholder="Olá! compartilhe aqui a sua ideia ou link..." name="dialogo" title="Olá! compartilhe aqui a sua ideia ou link..." ></textarea>
             <%
                if (Model.bolEducador)
                {
            %>
        ...
        <div class="mensagem_multimidia">
            <ul class="right">
                <%
                    ...
                    %>
                <!--<li class="multimidia_audio">
                    <a href="javascript:void(0);"><span class="FontAwesome"></span> Áudio</a>
                </li>
                <li class="multimidia_documentos">
                    <a href="javascript:void(0);"><span class="FontAwesome"></span> Documentos</a>
                </li>-->
            </ul>
        </div>
        <%
        ...
        <div class="botoes right">
            ...
            <input type="button" name="compartilhar" id="compartilhar" value="Compartilhar" class="btn_cor" style="display:none;" /> 
            <input type="button" name="agendar" id="agendar" value="Agendar" class="btn_cor" style="display:none;" />

        </div>
        <p class="mensagemerro" style="display: none;">Você precisa adicionar participantes</p>
