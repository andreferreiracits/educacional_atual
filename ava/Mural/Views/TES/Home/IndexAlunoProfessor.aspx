...
<asp:Content ContentPlaceHolderID="PageJsArea" ID="PageJsArea" runat="server">
    ...
    <script src="/AVA/StaticContent/Common/Scripts/timeline_2.0.0.js<%=Url.TimeStampLink() %>"
    ...
    $(function () {
        ...
        ********************************************************************/
        var strMensagemPadrao = "Olá! Compartilhe aqui ideias ou links! " + teste;
...
<p> Josias </p>
    <section class="hs1">        
            <%
                ...
                {
                    %>
                    <section class="aluno_sem_turma">
				        <h2>O ano está começando!</h2>
				        <p>O seu cadastro está sendo realizado e, quando for concluído, a sua rede social voltará ao normal. <br> Aguarde!</p>
			        </section>
                    <%    
                }
                ...
                else if (Model.bolAcessoEscrever && !(Model.bolSuspenso) && Model.intComunicacaoPermissao == 1)
                {
                    Html.RenderPartial("Partials/MensagemRapida", Model, new ViewDataDictionary { { "idAlbum", ViewData["idAlbum"] }, { "idArquivoMultimidia", ViewData["idArquivoMultimidia"] }, { "bolConfigImagem", ViewData["bolConfigImagem"] }, { "bolConfigVideo", ViewData["bolConfigVideo"] }, { "bolConfigFile", ViewData["bolConfigFile"] } });
            ...
            {
                %>
                <section class="divulga"></section>
                <%
            } 
            %>
            <section class="timeline">
                <header class="h_timeline">
                    <!--<div style="float:right; height:15px; width:180px;"><select><option>Professores da zuera</option></select></div>-->
