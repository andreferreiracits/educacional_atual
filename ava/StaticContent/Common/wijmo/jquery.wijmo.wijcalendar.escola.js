...
(function ($) {
    ...
    $.widget("wijmo.wijcalendar", {
        ...
        onDayClicked: function (e) {
            ...
            if (this.isPopupShowing()) {
                ...
                var text = "/AVA/Agenda/Escola/VerificaEventoData?data=" + dataf + "&idCategoria=" + idCategoria + "&idEscola=" + idEscola;
                //alert(text);
    ...
    wijMonthView.prototype = {
        ...
        _fillDayCell: function (hw, date, previewMode) {
            ...
            */
            //************* ANA ***************							
            var urlAVA = "/AVA/Agenda/Escola/VerificaEventoData?data=" + dayBR + "&idCategoria=" + idCategoria + "&idEscola=" + idEscola;
        ...
        getHtml: function (tableOnly) {
            ...
            if (!tableOnly && !previewMode && this.showPreview) {
                ...
                hw.writeAttribute('href', '/AVA/Agenda/Escola/VerificaEventoData');
                hw.writeAttribute('rel', '/AVA/Agenda/Escola/VerificaEventoData');
            ...
            verificaEventos(dataBR, idCategoria, idEscola);
            return hw.toString();
