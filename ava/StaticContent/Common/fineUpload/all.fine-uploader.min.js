...
! function(global) {
    var qq = function(e) {
        ...
        return {
            ...
            remove: function() {
                ...
                objetoImagens.imagens.splice(e,1);

                objetoArquivos.arquivos.splice(e,1);
    ...
    function() {
        ...
        qq.Error = function(e) {
    ...
    }(), qq.version = "5.11.7", qq.supportedFeatures = function() {
            "use strict";
            ...
            var l, c, d, p, q, h, f, m, g, _, v, b, S, y, w;
            return l = e(), p = l && qq.isXhrUploadSupported(), c = p && !qq.androidStock(), d = p && u(), q = d && t(), h = p && qq.isFileChunkingSupported(), f = p && h && a(), m = p && n(), g = l && (void 0 !== window.postMessage || p), v = i(), _ = o(), b = r(), S = s(), y = p && void 0 !== window.FileReader, w = function() {
            ...
            qq.extend(this, {
                then: function(o, s) {
                    return 0 === r ? (o && n.push(o), s && i.push(s)) : r === -1 ? s && s.apply(null, t) : o && o.apply(null, e), this
                },
                done: function(n) {
            ...
            function t() {
                var e = document.createElement("input");
                return e.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, i), e.setAttribute("title", s.title), o.setMultiple(s.multiple, e), s.folders && qq.supportedFeatures.folderSelection && e.setAttribute("webkitdirectory", ""), s.acceptFiles && e.setAttribute("accept", s.acceptFiles), e.setAttribute("type", "file"), e.setAttribute("name", s.name), qq(e).css({
                    position: "absolute",
                    right: 0,
                    top: 0,
                    fontFamily: "Arial",
                    ...
                    height: "100%"
                }), s.element.appendChild(e), r.attach(e, "change", function() {
                    s.onChange(e)
            ...
            qq.extend(s, e), i = qq.getUniqueId(), qq(s.element).css({
                position: "relative",
                overflow: "hidden",
                direction: "ltr"
            }), qq.extend(this, {
                ...
                setMultiple: function(e, t) {
                    ...
                    s.ios8BrowserCrashWorkaround && qq.ios8() && (qq.iosChrome() || qq.iosSafariWebView()) ? n.setAttribute("multiple", "") : e ? n.setAttribute("multiple", "") : n.removeAttribute("multiple")
                },
                setAcceptFiles: function(e) {
                    e !== s.acceptFiles && n.setAttribute("accept", e)
                },
                reset: function() {
                    n.parentNode && qq(n).remove(), qq(s.element).removeClass(s.focusClass), n = null, n = t()
                }
            }), n = t()
            ...
            qq.extend(this, {
                addFile: function(t) {
                    ...
                    return t.batchId && (o[i].batchId = t.batchId, void 0 === u[t.batchId] && (u[t.batchId] = []), u[t.batchId].push(i)), t.proxyGroupId && (o[i].proxyGroupId = t.proxyGroupId, void 0 === a[t.proxyGroupId] && (a[t.proxyGroupId] = []), a[t.proxyGroupId].push(i)), o[i].id = i, r[t.uuid] = i, void 0 === s[n] && (s[n] = []), s[n].push(i), e.onStatusChange(i, null, n), i
                },
                retrieve: function(e) {
                ...
                setStatus: function(t, n) {
                    ...
                    var i = o[t].status,
                        r = qq.indexOf(s[i], t);
                    s[i].splice(r, 1), o[t].status = n, void 0 === s[n] && (s[n] = []), s[n].push(t), e.onStatusChange(t, i, n)
                    }
                    catch(err){
            ...
            qq.basePublicApi = {
                ...
                addFiles: function(e, t, n) {
                    ...
                    this._currentBatchId = i, e && (l(), qq.each(e, function(e, t) {
                        qq.isFileOrInput(t) ? u(t) : qq.isBlob(t) ? o(t) : qq.isObject(t) ? t.blob && t.name ? r(t) : t.canvas && t.name && a(t) : t.tagName && "canvas" === t.tagName.toLowerCase() ? s(t) : c.log(t + " is not a valid file container!  Ignoring!", "warn")
                ...
                drawThumbnail: function(e, t, n, i, o) {
                    var r, s, a = new qq.Promise;
                    return this._imageGenerator ? (r = this._thumbnailUrls[e], s = {
                        customResizeFunction: o,
                        maxSize: n > 0 ? n : null,
                        scale: n > 0
                    }, !i && qq.supportedFeatures.imagePreviews && (r = this.getFile(e)), null == r ? a.failure({
                        container: t,
                        error: "File or URL not found."
                    }) : this._imageGenerator.generate(r, t, s).then(function(e) {
                        a.success(e)
                    }, function(e, t) {
                        a.failure({
                            container: e,
                ...
                _createStore: function(e, t) {
                    var n = {},
                        ...
                        u = function(e, t) {
                            r && qq.isObject(t) && qq.extend(t, a()), o[e] && qq.extend(t, o[e])
                        };
                    return {
                        set: function(e, t) {
                            null == t ? (n = {}, i = s(e)) : n[t] = s(e)
                        },
                        get: function(e) {
                            var t;
                            return t = null != e && n[e] ? n[e] : s(i), u(e, t), s(t)
                        },
                    ...
                    var n = this,
                        ...
                        o = {
                            ...
                            onComplete: function(e, t, o, r) {
                                delete i[e];
                                var s, a = n.getUploads({
                                    id: e
                                }).status;
                                a !== qq.status.UPLOAD_SUCCESSFUL && a !== qq.status.UPLOAD_FAILED && (s = n._onComplete(e, t, o, r), s instanceof qq.Promise ? s.done(function() {
                ...
                _handleNewFile: function(e, t, n) {
                    ...
                    !qq.isInput(a) && a.size >= 0 && (r = a.size), u(a, s, o, r, n, t, this._options.request.uuidName, {
                ...
                _handleNewFileGeneric: function(e, t, n, i, o, r) {
                    var s = this._uploadData.addFile({
                        uuid: n,
                        name: t,
                        size: i,
                        batchId: r
                    });
                    this._handler.add(s, e), this._trackButton(s), this._netUploadedOrQueued++, o.push({
                        id: s,
                        file: e
                    })
                },
                ...
                _itemError: function(e, t, n) {
                    ...
                    var o, r, s = this._options.messages[e],
                        a = [],
                        u = [].concat(t),
                        l = u[0],
                    ...
                    }), o = a.join(", ").toLowerCase(), i("{file}", this._options.formatFileName(l)), i("{extensions}", o), i("{sizeLimit}", this._formatSize(d.sizeLimit)), i("{minSizeLimit}", this._formatSize(d.minSizeLimit)), r = s.match(/(\{\w+\})/g), null !== r && qq.each(r, function(e, t) {
                        i(t, u[e])
                    }), this._options.callbacks.onError(null, l, s, void 0), s
                },
                    ...
                    if (t.length > n)
                        if (e || !this._options.validation.stopOnFirstInvalidFile) setTimeout(function() {
                            var e = r._getValidationDescriptor(t[n]),
                                s = r._getButtonId(t[n].file),
                                a = r._getButton(s);
                            r._handleCheckedCallback({
                                name: "onValidate",
                                callback: qq.bind(r._options.callbacks.onValidate, r, e, a),
                ...
                _onValidateBatchCallbackSuccess: function(e, t, n, i, o) {
                    var r, s = this._currentItemLimit,
                        a = this._netUploadedOrQueued;
                    0 === s || a <= s ? t.length > 0 ? this._handleCheckedCallback({
                        name: "onValidate",
                    ...
                    }) : this._itemError("noFilesError") : (this._onValidateBatchCallbackFailure(t), r = this._options.messages.tooManyItemsError.replace(/\{netItems\}/g, a).replace(/\{itemLimit\}/g, s), this._batchError(r))
                },
                ...
                _onValidateCallbackSuccess: function(e, t, n, i) {
                    var o = this,
                        r = t + 1,
                        s = this._getValidationDescriptor(e[t]);
                    this._validateFileOrBlobData(e[t], s).then(function() {
                ...
                _validateFileOrBlobData: function(e, t) {
                	var caracterPermitido = /[^a-zA-Z0-9\U003F-U007B\U003B\U003D\U007D\U007E\U00B7\U0020\U0021\U002D\_\.\s\-\/\\]/gi;
/*                   var caracterPermitido = /^[\u00C0-\u00D6\u00D8-\u00f6\u00f8-\u00ff]/gi;*/
                    var nomePermitido;
                    var tamanhoNomePermitido;
                    var n = this,
                        i = function() {
                        ...
                        o = t.name,
                        r = t.size,
                        s = this._getButtonId(e.file),
                        a = this._getValidationBase(s),
                        u = new qq.Promise;
                        var result = o.match(caracterPermitido);
                        console.log(result);
                        if(result == null){
                            nomePermitido = true; 
                        }else{
                        ...
                        if(o.length <= 100){
                            tamanhoNomePermitido = true;
                        }else{

                            tamanhoNomePermitido = false;
                        }
                    ...
                    , qq.isFileOrInput(i) && !this._isAllowedExtension(a.allowedExtensions, o) ? (this._itemError("typeError", o, i), u.failure())
                    : 0 === r ? (this._itemError("emptyError", o, i), u.failure()) 
                    : (!nomePermitido) ? (this._itemError("ErroNome", o, i), u.failure()) 
                    : (!tamanhoNomePermitido) ? (this._itemError("ErroTamanho", o, i), u.failure()) 
                    : r > 0 && a.sizeLimit && r > a.sizeLimit ? (this._itemError("sizeError", o, i), u.failure()) 
                    : r > 0 && r < a.minSizeLimit ? (this._itemError("minSizeError", o, i), u.failure()) 
                    : (qq.ImageValidation && qq.supportedFeatures.imagePreviews && qq.isFile(i) ? new qq.ImageValidation(i, qq.bind(n.log, n)).validate(a.image).then(u.success, function(e) {
        ...
        function() {
            ...
            qq.FineUploaderBasic = function(e) {
                ...
                this._options = {
                    ...
                    messages: {
                        typeError: " O arquivo: {file} possui um formato n\u00E3o permitido ou seu professor bloqueou seus envios",
                        // typeError: "{file} possui uma extensão inválida ou você nã possui permissões. Valid extension(s): {extensions}.",
                        ...
                        noFilesError: "Sem arquivos para realizar upload.",
                        tooManyItemsError: "A quantidade de arquivos ultrapassa o limite m\u00E1ximo de {itemLimit} itens.",
                        //ErroNome: "O arquivo: {file} n\u00E3o pode conter caracteres especiais como:\u00E7 , \u00E1, \u00CB  ...",
                        ErroNome: "O nome do arquivo({file}) n\u00E3o pode conter caracteres especiais ou acentos. Renomeie o arquivo antes de fazer o upload.",
                        ErroTamanho: " O nome do arquivo({file}) n\u00E3o pode conter mais de 100 caracteres. Renomeie o arquivo antes de fazer o upload.",
                        maxHeightImageError: "Image is too tall.",
                        maxWidthImageError: "Image is too wide.",
                        minHeightImageError: "Image is not tall enough.",
                        minWidthImageError: "Image is not wide enough.",
                        retryFailTooManyItems: "Retry failed - you have reached your file limit.",
                        onLeave: "O upload est\u00E1 sendo realizado, se sair o upload ser\u00E1 cancelado.",
            ...
            function a(e, t) {
                var n = r(e),
                    o = y.method,
                    a = t === !0;
                s(e), a ? _(o + " request for " + e + " has failed", "error") : i(n) || m(n.status) || (a = !0, _(o + " request for " + e + " has failed - response code " + n.status, "error")), y.onComplete(e, n, a)
            }
            ...
            function l(e, t) {
                ...
                return y.onSend(e), n = c(e, a, S[e].additionalQueryParams), i(o) ? (o.onload = q(e), o.onerror = h(e)) : o.onreadystatechange = d(e), p(e), o.open(s, n+xyz+t, !0), y.cors.expected && y.cors.sendCredentials && !i(o) && (o.withCredentials = !0), f(e), _("Sending " + s + " request for " + e), l ? o.send(l) : v || !a ? o.send() : a && y.contentType && y.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >= 0 ? o.send(qq.obj2url(a, "")) : a && y.contentType && y.contentType.toLowerCase().indexOf("application/json") >= 0 ? o.send(JSON.stringify(a)) : o.send(a), o
            }
            ...
            function f(e) {
                var o = r(e),
                    s = y.customHeaders,
                    a = S[e].additionalHeaders || {},
                    u = y.method,
                    l = {};
                i(o) || (y.acceptHeader && o.setRequestHeader("Accept", y.acceptHeader), y.allowXRequestedWithAndCacheControl && (y.cors.expected && t() && !n(s) || (o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.setRequestHeader("Cache-Control", "no-cache"))), !y.contentType || "POST" !== u && "PUT" !== u || o.setRequestHeader("Content-Type", y.contentType), qq.extend(l, qq.isFunction(s) ? s(e) : s), qq.extend(l, a), qq.each(l, function(e, t) {
            ...
            function g(e, t, n, i, o, r, s) {
                ...
                var a = b.push(e);
                if (a <= y.maxConnections) return l(e, t)
            }
            var _, v, b = [],
                S = {},
                y = {
            ...
            v = "GET" === y.method || "DELETE" === y.method, qq.extend(this, {
                initTransport: function(e) {
                    ...
                    return {
                        ...
                        send: function(a) {
                            return r && qq.indexOf(["GET", "DELETE"], y.method) >= 0 && (n.qqtimestamp = (new Date).getTime()), g(e, a, t, n, s, i, o)
                        }
                    }
                },
                canceled: function(e) {
            ...
            var n, i, o, r = this,
                ...
                l = {
                    ...
                    finalize: function(e) {
                        var t = u.getSize(e),
                            n = u.getName(e);
                        i("All chunks have been uploaded for " + e + " - finalizing...."), o.finalizeChunks(e).then(function(r, s) {
                            i("Finalize successful for " + e);
                            var a = p.normalizeResponse(r, !0);
                            u.onProgress(e, n, t, t), o._maybeDeletePersistedChunkData(e), p.cleanup(e, a, s)
                        }, function(t, o) {
                    ...
                    sendNext: function(e) {
                        var t = u.getSize(e),
                            n = u.getName(e),
                            r = l.nextPart(e),
                            s = o._getChunkData(e, r),
                            d = o._getFileState(e).attemptingResume,
                            q = o._getFileState(e).chunking.inProgress || [];
                        null == o._getFileState(e).loaded && (o._getFileState(e).loaded = 0), d && u.onResume(e, n, s) === !1 && (l.reset(e), r = l.nextPart(e), s = o._getChunkData(e, r), d = !1), null == r && 0 === q.length ? l.finalize(e) : (i(qq.format("Sending chunked upload request for item {}.{}, bytes {}-{} of {}.", e, r, s.start + 1, s.end, t)), u.onUploadChunk(e, n, o._getChunkDataForCallback(s)), q.push(r), o._getFileState(e).chunking.inProgress = q, a && c.open(e, r), a && c.available() && o._getFileState(e).chunking.remaining.length && l.sendNext(e), o.uploadChunk(e, r, d).then(function(t, n) {
                            i("Chunked upload request succeeded for " + e + ", chunk " + r), o.clearCachedChunk(e, r);
                            var s = o._getFileState(e).chunking.inProgress || [],
                                a = p.normalizeResponse(t, !0),
                                u = qq.indexOf(s, r);
                            i(qq.format("Chunk {} for file {} uploaded successfully.", r, e)), l.done(e, r, a, n), u >= 0 && s.splice(u, 1), o._maybePersistChunkedState(e), l.hasMoreParts(e) || 0 !== s.length ? l.hasMoreParts(e) ? l.sendNext(e) : i(qq.format("File ID {} has no more chunks to send and these chunk indexes are still marked as in-progress: {}", e, JSON.stringify(s))) : l.finalize(e)
                        }, function(t, s) {
                            i("Chunked upload request failed for " + e + ", chunk " + r), o.clearCachedChunk(e, r);
                            var d, q = p.normalizeResponse(t, !1);
                            q.reset ? l.reset(e) : (d = qq.indexOf(o._getFileState(e).chunking.inProgress, r), d >= 0 && (o._getFileState(e).chunking.inProgress.splice(d, 1), o._getFileState(e).chunking.remaining.unshift(r))), o._getFileState(e).temp.ignoreFailure || (a && (o._getFileState(e).temp.ignoreFailure = !0, i(qq.format("Going to attempt to abort these chunks: {}. These are currently in-progress: {}.", JSON.stringify(Object.keys(o._getXhrs(e))), JSON.stringify(o._getFileState(e).chunking.inProgress))), qq.each(o._getXhrs(e), function(t, n) {
                                i(qq.format("Attempting to abort file {}.{}. XHR readyState {}. ", e, t, n.readyState)), n.abort(), n._cancelled = !0
                            }), o.moveInProgressToRemaining(e), c.free(e, !0)), u.onAutoRetry(e, n, q, s) || p.cleanup(e, q, s))
                        }).done(function() {
                            o.clearXhr(e, r)
                        }))
                    }
                ...
                c = {
                    ...
                    free: function(e, t) {
                        var n, r = !t,
                            s = qq.indexOf(c._waiting, e),
                            a = qq.indexOf(c._open, e);
                        delete c._openChunks[e], p.getProxyOrBlob(e) instanceof qq.BlobProxy && (i("Generated blob upload has ended for " + e + ", disposing generated blob."), delete o._getFileState(e).file), s >= 0 ? c._waiting.splice(s, 1) : r && a >= 0 && (c._open.splice(a, 1), n = c._waiting.shift(), n >= 0 && (c._open.push(n), p.start(n)))
                    },
                    ...
                    send: function(e, t) {
                        o._getFileState(e).loaded = 0, i("Sending simple upload request for " + e), o.uploadFile(e).then(function(n, o) {
                            ...
                            var r = p.normalizeResponse(n, !0),
                                s = u.getSize(e);
                            u.onProgress(e, t, s, s), p.maybeNewUuid(e, r), p.cleanup(e, r, o)
                        }, function(n, o) {
                ...
                p = {
                    ...
                    now: function(e) {
                        ...
                        u.onUpload(e, t), s && o._shouldChunkThisFile(e) ? l.sendNext(e) : d.send(e, t)
                    },
                    start: function(e) {
            ...
            qq.extend(this, {
                ...
                retry: function(e) {
                    return a && (o._getFileState(e).temp.ignoreFailure = !1), c.isUsingConnection(e) ? p.start(e) : r.upload(e)
                },
                cancel: function(e) {
                    var t = o.cancel(e);
            ...
            }), qq.extend(u, e), i = u.log, s = u.chunking.enabled && qq.supportedFeatures.chunking, a = s && u.chunking.concurrent.enabled, n = function() {
                var e = {};
            ...
            function t(e) {
                ...
                var t = document.getElementById(s._getIframeName(e));
            ...
            function o(e, t) {
                ...
                l[r] = t, c[o] = qq(e).attach("load", function() {
                    s.getInput(o) && (f("Received iframe load event for CORS upload request (iframe name " + i + ")"), d[i] = setTimeout(function() {
                    ...
                    var t, o = (n(i), s._parseJsonResponse(e)),
                        r = o.uuid;
                    r && l[r] ? (f("Handling response for iframe name " + i), clearTimeout(d[i]), delete d[i], s._detachLoadEvent(i), t = l[r], delete l[r], m.stopReceivingMessages(i), t(o)) : r || f("'" + e + "' does not contain a UUID - ignoring.")
                })
            }
            var r = e.options,
                s = this,
            ...
            qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function(e) {
                return {
                    add: function(t, n) {
                        e.add(t, {
                            input: n
                        }), n.setAttribute("name", q), n.parentNode && qq(n).remove()
                    },
                    expunge: function(n) {
                        t(n), e.expunge(n)
                    },
                    isValid: function(t) {
                        return e.isValid(t) && void 0 !== s._getFileState(t).input
                    }
                }
            }), qq.extend(this, {
                getInput: function(e) {
                    return s._getFileState(e).input
                },
                ...
                _initFormForUpload: function(e) {
                    var t = e.method,
                        ...
                        o = e.paramsInBody,
                        r = e.targetName,
                        s = qq.toElement("<form method='" + t + "' enctype='multipart/form-data'></form>"),
                        a = n;
                    return o ? qq.obj2Inputs(i, s) : a = qq.obj2url(i, n), s.setAttribute("action", a), s.setAttribute("target", r), s.style.display = "none", document.body.appendChild(s), s
                },
            ...
            var n = this,
                ...
                s = e.options.resume,
                a = r && e.options.chunking.enabled && qq.supportedFeatures.chunking,
                u = s && e.options.resume.enabled && a && qq.supportedFeatures.resume,
                l = o.getName,
                c = o.getSize,
                d = o.getUuid,
                p = o.getEndpoint,
            ...
            qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function(e) {
                ...
                _getLocalStorageId: function(e) {
                    var t = "5.0",
                        ...
                        s = r.partSize,
                        a = p(e);
                    return qq.format("qq{}resume{}-{}-{}-{}-{}", i, t, n, o, s, a)
                },
                ...
                _maybePrepareForResume: function(e) {
                    var t, i, o = n._getFileState(e);
                    u && void 0 === o.key && (t = n._getLocalStorageId(e), i = localStorage.getItem(t), i && (i = JSON.parse(i), q(i.uuid) ? n._markNotResumable(e) : (m(qq.format("Identified file with ID {} and name of {} as resumable.", e, l(e))), h(e, i.uuid), o.key = i.key, o.chunking = i.chunking, o.loaded = i.loaded, o.attemptingResume = !0, n.moveInProgressToRemaining(e))))
                },
                ...
                _registerProgressHandler: function(e, t, i) {
                    var o = n._getXhr(e, t),
                        ...
                        s = {
                            simple: function(t, n) {
                                var i = c(e);
                                t === n ? f(e, r, i, i) : f(e, r, t >= i ? i - 1 : t, i)
                            },
                            chunked: function(o, s) {
                                var a = n._getFileState(e).temp.chunkProgress,
                    ...
                    o.upload.onprogress = function(e) {
                        if (e.lengthComputable) {
                            ...
                            s[t](e.loaded, e.total)
                        }
                    }
                },
                _registerXhr: function(e, t, i, o) {
                    var r = null == t ? -1 : t,
                        s = n._getFileState(e).temp;
                    return s.xhrs = s.xhrs || {}, s.ajaxRequesters = s.ajaxRequesters || {}, s.xhrs[r] = i, o && (s.ajaxRequesters[r] = o), i
                },
        ...
        function() {
            ...
            function t(e, t, n) {
                var i, o, r, s, a = document.createElement("canvas"),
                    u = 0,
                    l = n,
                    c = n;
                for (a.width = 1, a.height = n, i = a.getContext("2d"), i.drawImage(e, 0, 0), o = i.getImageData(0, 0, 1, n).data; c > u;) r = o[4 * (c - 1) + 3], 0 === r ? l = c : u = c, c = l + u >> 1;
                return s = c / n, 0 === s ? 1 : s
            }
            ...
            function n(e, t, n, i) {
                ...
                return o(e, t, r, n, i).then(function() {
                    a.success(r.toDataURL(s, n.quality || .8))
                }), a
            }
            ...
            function o(n, o, a, u, l) {
                ...
                return f.save(), u.resize ? r({
                    ...
                    origWidth: q,
                    origHeight: h
                }), c && (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h", q, h, c.newWidth, c.newHeight), "warn"), q = c.newWidth, h = c.newHeight)), s(a, q, h, u.orientation), qq.ios() ? ! function() {
                    e(n) && (d /= 2, p /= 2);
                    var i, o, r, s = 1024,
                        ...
                        g = 0,
                        _ = 0;
                    for (a.width = a.height = s, i = a.getContext("2d"); g < p;) {
                        for (o = 0, r = 0; o < d;) i.clearRect(0, 0, s, s), i.drawImage(n, -o, -g), f.drawImage(a, 0, 0, s, s, r, _, c, m), o += s, r += c;
                        g += s, _ += m
                    }
                    f.restore(), a = i = null
                }() : f.drawImage(n, 0, 0, q, h), a.qqImageRendered && a.qqImageRendered(), m.success(), m)
            }
            ...
            function r(e) {
                var t = e.blob,
                    ...
                    p = e.targetHeight,
                    q = e.targetWidth;
                return s(l, o, i, r), d.height = p, d.width = q, c.drawImage(n, 0, 0), u({
                    blob: t,
                    height: p,
                    image: n,
                    sourceCanvas: l,
                    ...
                    d.qqImageRendered && d.qqImageRendered(), a.success()
                }, a.failure), a
            }
            ...
            a.prototype.render = function(e, t) {
                ...
                return this.imageLoadListeners ? void this.imageLoadListeners.push(function() {
                    r.render(e, t)
                }) : (u && !l ? l = a * u / s << 0 : l && !u ? u = s * l / a << 0 : (u = s, l = a), c && u > c && (u = c, l = a * u / s << 0), d && l > d && (l = d, u = s * l / a << 0), i = {
                    width: u,
                    height: l
                }, qq.each(t, function(e, t) {
                    i[e] = t
                ...
                }() : "canvas" === q && o(this.srcImage, this.blob, e, i, p), void("function" == typeof this.onrender && this.onrender(e)))
            }, qq.MegaPixImage = a
            ...
            function l(i, o) {
                var r = t(i) || n(i);
                return t(i) ? a(i, o) : n(i) ? u(i, o) : (o.failure(i), e(qq.format("Element container of type {} is not supported!", i.tagName), "error")), r
            }
            ...
            function d(e, t, n, i, o) {
                var a = new Image,
                    u = new qq.Promise;
                l(a, u), s(e) && (a.crossOrigin = "anonymous"), a.src = e, u.then(function() {
                    l(t, n);
                    var s = new qq.MegaPixImage(a);
                    s.render(t, {
                        maxWidth: i,
                        maxHeight: i,
                        mime: r(e),
            ...
            function q(e, r, a) {
                var u = new qq.Promise,
                    c = a.scale,
                    q = c ? a.maxSize : null;
                return c && t(r) ? o() ? s(e) && !i() ? p(e, r, u, q) : d(e, r, u, q) : p(e, r, u, q) : n(r) ? d(e, r, u, q) : l(r, u) && (r.src = e), u
            }
            qq.extend(this, {
                generate: function(t, n, i) {
                    return qq.isString(t) ? (e("Attempting to update thumbnail based on server response."), q(t, n, i || {})) : (e("Attempting to draw client-side image preview."), c(t, n, i || {}))
                }
            }), this._testing = {}, this._testing.isImg = t, this._testing.isCanvas = n, this._testing.isCrossOrigin = s, this._testing.determineMimeOfFileName = r
            ...
            function l(e, t) {
                var i = 16,
                    o = qq.extend([], c),
                    r = {};
                return qq.each(t, function(t, s) {
                    var a, u, l, c = s.slice(0, 4),
                        p = e ? n(c) : parseInt(c, 16),
                        q = o.indexOf(p);
                    if (q >= 0 && (u = d[p].name, l = d[p].bytes, a = s.slice(i, i + 2 * l), r[u] = e ? n(a) : parseInt(a, 16), o.splice(q, 1)), 0 === o.length) return !1
                }), r
            }
            var c = [274],
                d = {
                ...
                parse: function() {
                    ...
                    return o().then(function(o) {
                        t(qq.format("Moving forward with EXIF header parsing for '{}'", void 0 === e.name ? "blob" : e.name)), r(o).then(function(e) {
                            t(qq.format("EXIF Byte order is {} endian", e ? "little" : "big")), s(o, e).then(function(r) {
                                t(qq.format("Found {} APP1 directory entries", r)), a(o, r).then(function(i) {
                                    var o = u(i),
                                        r = l(e, o);
            ...
            qq.extend(this, {
                isPreviewable: function() {
                    var i = this,
                        o = new qq.Promise,
                        r = !1,
                        s = void 0 === e.name ? "blob" : e.name;
                    return t(qq.format("Attempting to determine if {} can be rendered in this browser", s)), t("First pass: check type attribute of blob object."), this.isPreviewableSync() ? (t("Second pass: check for magic bytes in file header."), qq.readBlobToHex(e, 0, 4).then(function(e) {
                        ...
                        }), t(qq.format("'{}' is {} able to be rendered in this browser", s, r ? "" : "NOT")), r || o.failure()
                    }, function() {
                        t("Error reading file w/ name '" + s + "'.  Not able to be rendered in this browser."), o.failure()
                    })) : o.failure(), o
                },
            ...
            function n(e, n, o, r) {
                ...
                n = n && t(e), n && qq.each(e, function(e, t) {
                    if (null == t.uuid) s = !0, i.log(qq.format("Session response item {} did not include a valid UUID - ignoring.", e), "error");
                    else if (null == t.name) s = !0, i.log(qq.format("Session response item {} did not include a valid name - ignoring.", e), "error");
                    else try {
                        return i.addFileRecord(t), !0
                    } catch (e) {
                        s = !0, i.log(e.message, "error")
                    }
                    return !1
                }), r[n && !s ? "success" : "failure"](e, o)
            }
            var i = {
                endpoint: null,
                params: {},
            ...
            qq.extend(this, {
                ...
                getFileRecords: function(e, c, d) {
                    ...
                    return f.isPreviewableSync() ? (qq.each(l, function(e, i) {
                        ...
                        q.push({
                            ...
                            blob: new qq.BlobProxy(h, qq.bind(p._generateScaledImage, p, {
                ...
                handleNewFile: function(e, t, n, i, o, r, s, a) {
                    var u = this,
                        l = (e.qqButtonId || e.blob && e.blob.qqButtonId, []),
                        c = null,
                        d = a.addFileToHandler,
                        p = a.uploadData,
                        q = a.paramsStore,
                        h = qq.getUniqueId();
            ...
            scaleImage: function(e, t, n) {
                ...
                return qq.Scaler && qq.supportedFeatures.imagePreviews && r ? qq.bind(function() {
                    var t = c.getFileRecords(u, a, r)[0];
            ...
            _getName: function(e, t) {
                ...
                var n = e.lastIndexOf("."),
                    ...
                    s = qq.getExtension(e),
                    a = "";
                return t.name && t.name.trim().length && (a = " (" + t.name + ")"), n >= 0 ? (r = e.substr(0, n), o !== i && (s = i.split("/")[1]), r += a + "." + s) : r = e + a, r
            },
            ...
            _generateScaledImage: function(e, t) {
                ...
                var n = this,
                    ...
                    u = e.quality,
                    l = e.failedText,
                    c = e.includeExif && "image/jpeg" === t.type && "image/jpeg" === a,
                    d = new qq.Promise,
                    p = new qq.ImageGenerator(o),
                    q = document.createElement("canvas");
                return o("Attempting to generate scaled version for " + t.name), p.generate(t, q, {
                    maxSize: r,
                    orient: s,
                    customResizeFunction: i
                }).then(function() {
                    var e = q.toDataURL(a, u),
                        i = function() {
            ...
            return e.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e.encode64 = function(e) {
                var t, n, i, o, r, s = "",
                    ...
                    u = "",
                    l = 0;
                do t = e[l++], n = e[l++], a = e[l++], i = t >> 2, o = (3 & t) << 4 | n >> 4, r = (15 & n) << 2 | a >> 6, u = 63 & a, isNaN(n) ? r = u = 64 : isNaN(a) && (u = 64), s = s + this.KEY_STR.charAt(i) + this.KEY_STR.charAt(o) + this.KEY_STR.charAt(r) + this.KEY_STR.charAt(u), t = n = a = "", i = o = r = u = ""; while (l < e.length);
                return s
                ...
                do i = this.KEY_STR.indexOf(e.charAt(u++)), o = this.KEY_STR.indexOf(e.charAt(u++)), r = this.KEY_STR.indexOf(e.charAt(u++)), a = this.KEY_STR.indexOf(e.charAt(u++)), t = i << 2 | o >> 4, n = (15 & o) << 4 | r >> 2, s = (3 & r) << 6 | a, l.push(t), 64 != r && l.push(n), 64 != a && l.push(s), t = n = s = "", i = o = r = a = ""; while (u < e.length);
                return l
            }, e
            ...
            var n = {},
                ...
                c = function(e, t, n) {
                    (0 === t.length || u(t, n)) && (a(o, o), this.reset())
                },
                d = function(e) {
                    var i = t(e);
                    i > 0 && (p(e, 0, i), n[e] = {
                ...
                p = function(e, t, r) {
                    var s = n[e] ? n[e].loaded : 0,
                        u = n[e] ? n[e].total : 0;
                    t === -1 && r === -1 ? (i -= s, o -= u) : (t && (i += t - s), r && (o += r - u)), a(i, o)
                };
            qq.extend(this, {
                onAllComplete: c,
                onStatusChange: function(e, t, n) {
            ...
            function i(e) {
                e.getAttribute("action") && (a.newEndpoint = e.getAttribute("action"))
            }
            ...
            qq.extend(this, {
                ...
                getFormInputsAsObject: function() {
                    return null == l ? null : a._form2Obj(l)
                }
            }), l = s(l), this.attachedToForm = !!l
            ...
            function n(e, t) {
                var n, i, r;
                try {
                    i = t.contentDocument || t.contentWindow.document, r = i.body.innerHTML, a("converting iframe's innerHTML to JSON"), a("innerHTML = " + r), r && r.match(/^<pre/i) && (r = i.body.firstChild.firstChild.nodeValue), n = o._parseJsonResponse(r)
                } catch (e) {
                    a("Error when attempting to parse form upload response (" + e.message + ")", "error"), n = {
                        success: !1
                    }
                }
                return n
            ...
            function i(t, n) {
                var i = e.paramsStore.get(t),
                    a = "get" === e.method.toLowerCase() ? "GET" : "POST",
                    u = e.endpointStore.get(t),
                    l = r(t);
                return i[e.uuidName] = s(t), i[e.filenameParam] = l, o._initFormForUpload({
                    method: a,
                    endpoint: u,
                    params: i,
            ...
            this.uploadFile = function(t) {
                var r, s = o.getInput(t),
                    u = o._createIframe(t),
                    l = new qq.Promise;
                return r = i(t, u), r.appendChild(s), o._attachLoadEvent(u, function(i) {
                    a("iframe loaded");
                    var r = i ? i : n(t, u);
                    o._detachLoadEvent(t), e.cors.expected || qq(u).remove(), r.success ? l.success(r) : l.failure(r)
                }), a("Sending upload request for " + t), r.submit(), qq(r).remove(), l
            ...
            var n = this,
                ...
                r = t.getUuid,
                s = t.log,
                a = e.forceMultipart || e.paramsInBody,
                u = function(t, n, r) {
                    var s = o(t),
                        u = i(t);
                    n[e.chunking.paramNames.partIndex] = r.part, n[e.chunking.paramNames.partByteOffset] = r.start, n[e.chunking.paramNames.chunkSize] = r.size, n[e.chunking.paramNames.totalParts] = r.count, n[e.totalFileSizeName] = s, a && (n[e.filenameParam] = u)
                },
                ...
                d = function(t) {
                    var s = e.paramsStore.get(t),
                        a = i(t),
                        u = o(t);
                    return s[e.uuidName] = r(t), s[e.filenameParam] = a, s[e.totalFileSizeName] = u, s[e.chunking.paramNames.totalParts] = n._getTotalChunks(t), s
                },
                p = function(e, t) {
                ...
                q = function(e, t) {
                    var n;
                    return s("xhr - server response received for " + e), s("responseText = " + t.responseText), n = h(!0, t), {
                        success: !p(t, n),
                        response: n
                    }
                },
                h = function(e, t) {
                    var n = {};
                    try {
                        s(qq.format("Received response status {} with body: {}", t.status, t.responseText)), n = qq.parseJson(t.responseText)
                    } catch (t) {
                        e && s("Error when attempting to parse xhr response text (" + t.message + ")", "error")
                    }
                    return n
                },
                f = function(t) {
                ...
                m = function(t, n, s, u) {
                    var l = new FormData,
                        c = e.method,
                        d = e.endpointStore.get(u),
                        p = i(u),
                        q = o(u);
                    return t[e.uuidName] = r(u), t[e.filenameParam] = p, a && (t[e.totalFileSizeName] = q), e.paramsInBody || (a || (t[e.inputName] = p), d = qq.obj2url(t, d)), n.open(c, d, !0), e.cors.expected && e.cors.sendCredentials && (n.withCredentials = !0), a ? (e.paramsInBody && qq.obj2FormData(t, l), l.append(e.inputName, s), l) : s
                },
                g = function(t, i) {
                    var o = e.customHeaders.get(t),
                        r = n.getFile(t);
                    i.setRequestHeader("Accept", "application/json"), i.setRequestHeader("X-Requested-With", "XMLHttpRequest"), i.setRequestHeader("Cache-Control", "no-cache"), a || (i.setRequestHeader("Content-Type", "application/octet-stream"), i.setRequestHeader("X-Mime-Type", r.type)), qq.each(o, function(e, t) {
                        i.setRequestHeader(e, t)
                    })
                };
            qq.extend(this, {
                uploadChunk: function(t, i, r) {
                    var s, a, l, d = n._getChunkData(t, i),
                        p = n._createXhr(t, i);
                    o(t);
                    return s = c(t, p), n._registerProgressHandler(t, i, d.size), l = e.paramsStore.get(t), u(t, l, d), r && (l[e.resume.paramNames.resuming] = !0), a = m(l, p, d.blob, t), g(t, p), p.send(a), s
                },
                uploadFile: function(t) {
                    var i, o, r, s, a = n.getFile(t);
                    return o = n._createXhr(t), n._registerProgressHandler(t), i = c(t, o), r = e.paramsStore.get(t), s = m(r, o, a, t), g(t, o), o.send(s), i
                }
                ...
                return {
                    finalizeChunks: function(n) {
                        return e.chunking.success.endpoint ? f(n) : t.finalizeChunks(n, qq.bind(h, this, !0))
                    }
                }
            })
            ...
            qq.extend(i, e), t = qq.extend(this, new qq.AjaxRequester({
                ...
                complete: function(e, n, r, s) {
                    var a = new qq.Promise;
                    return i.log("Submitting All Chunks Done request for " + e), o[e] = a, t.initTransport(e).withParams(r).withHeaders(s).send(n), a
                }
            })
            ...
            function n(e) {
                ...
                return e.isFile ? e.file(function(n) {
                    var i = e.name,
                        o = e.fullPath,
                        r = o.indexOf(i);
                    o = o.substr(0, r), "/" === o.charAt(0) && (o = o.substr(1)), n.qqPath = o, q.push(n), t.success()
                }, function(n) {
            ...
            function i(e, t, n, o) {
                var r = o || new qq.Promise,
                    s = t || e.createReader();
                return s.readEntries(function(t) {
            ...
            function o(e, t) {
                var i = [],
                    o = new qq.Promise;
                return l.callbacks.processingDroppedFiles(), t.dropDisabled(!0), e.files.length > 1 && !l.allowMultipleItems ? (l.callbacks.processingDroppedFilesComplete([]), l.callbacks.dropError("tooManyFilesError", ""), t.dropDisabled(!1), o.failure()) : (q = [], qq.isFolderDropSupported(e) ? qq.each(e.items, function(e, t) {
                    var r = t.webkitGetAsEntry();
                    r && (r.isFile ? q.push(t.getAsFile()) : i.push(n(r).done(function() {
                        i.pop(), 0 === i.length && o.success()
                    })))
                }) : q = e.files, 0 === i.length && o.success()), o
            }
            ...
            l = {
                ...
                dispose: function() {
                    h.dispose(), qq.each(p, function(e, t) {
                        t.dispose()
                    })
                }
            })
            ...
            function r() {
                function e() {
                    t = document.createEvent("Event"), t.initEvent(a.HIDE_ZONES_EVENT_NAME, !0, !0)
                }
                var t;
                if (window.CustomEvent) try {
                    t = new CustomEvent(a.HIDE_ZONES_EVENT_NAME)
                } catch (t) {
                    e()
                } else e();
            ...
            function s() {
                d.attach(u, "dragover", function(e) {
                    ...
                    if (!o()) {
                        if (!i(e)) return;
                        e.preventDefault(), e.stopPropagation(), a.onDrop(e), r()
                    }
                })
            }
            var a, u, l, c, d = new qq.DisposeSupport;
            a = {
                element: null,
                onEnter: function(e) {},
                onLeave: function(e) {},
                ...
                onDrop: function(e) {}
            }, qq.extend(a, e), u = a.element, n(), s(), qq.extend(this, {
        ...
        function() {
            ...
            qq.uiPublicApi = {
                ...
                _onComplete: function(e, t, n, i) {
                    function o(t) {
                        a && (s.setStatusText(e), qq(a).removeClass(u._classes.retrying), s.hideProgress(e), u.getUploads({
                            id: e
                        }).status !== qq.status.UPLOAD_FAILED && s.hideCancel(e), s.hideSpinner(e), t.success ? u._markFileAsSuccessful(e) : (qq(a).addClass(u._classes.fail), s.showCancel(e), s.isRetryPossible() && !u._preventRetries[e] && (qq(a).addClass(u._classes.retryable), s.showRetry(e)), u._controlFailureTextDisplay(e, t)))
                    }
                    var r = this._parent.prototype._onComplete.apply(this, arguments),
                        s = this._templating,
                        a = s.getFileContainer(e),
                        u = this;
                ...
                _showDeleteConfirm: function(e, t, n) {
                    var i, o = this.getName(e),
                        ...
                        s = (this.getUuid(e), arguments),
                        a = this;
                    i = this._options.showConfirm(r), qq.isGenericPromise(i) ? i.then(function() {
                        a._sendDeleteRequest.apply(a, s)
                    }) : i !== !1 && a._sendDeleteRequest.apply(a, s)
                },
                _addToList: function(e, t, n) {
                    var i, o, r = 0,
                        s = this._handler.isProxied(e) && this._options.scaling.hideScaled;
            ...
            this._parent = t ? qq[t].FineUploaderBasic : qq.FineUploaderBasic, this._parent.apply(this, arguments), qq.extend(this._options, {
                ...
                deleteFile: {
                    forceConfirm: !1,
                    confirmMessage: "Deseja excluir o arquivo {filename}?",
            ...
            "use strict";
            var t, n, i, o, r, s, a, u, l = "qq-file-id",
                c = "qq-file-id-",
                d = "qq-max-size",
                p = "qq-server-scale",
                q = "qq-hide-dropzone",
                ...
                F = function() {
                    ...
                    a && (e ? w.imageGenerator.generate(e, new Image, i).then(function(e) {
                        E.success(e)
                    }, function() {
                ...
                A = function(e) {
                    ...
                    return P.then(function(n) {
                        K(n, e), e.src ? t.success() : (e.src = n.src, e.onload = function() {
                ...
                T = function(e, n, i) {
                    ...
                    return t("Generating new thumbnail for " + e), n.qqThumbnailId = e, w.imageGenerator.generate(n, o, i).then(function() {
                        ...
                        x[e].failure(), w.placeholders.waitUntilUpdate || J(e, o)
                    })
                },
                I = function() {
                    if (S.length) {
                ...
                R = function(e) {
                    return G(H(e), C.cancel)
                },
                U = function(e) {
                    return G(H(e), C.continueButton)
                },
                D = function(e) {
                    return G(r, C[e + "Dialog"])
                },
                k = function(e) {
                    return G(H(e), C.deleteButton)
                },
                B = function() {
                    return G(r, C.dropProcessing)
                },
                N = function(e) {
                    return G(H(e), C.editNameIcon)
                },
                H = function(e) {
                    return g.map[e] || qq(s).getFirstByClass(c + e)
                },
                O = function(e) {
                    return G(H(e), C.file)
                },
                M = function(e) {
                    return G(H(e), C.pause)
                },
                L = function(e) {
                    return null == e ? G(r, C.totalProgressBarContainer) || G(r, C.totalProgressBar) : G(H(e), C.progressBarContainer) || G(H(e), C.progressBar)
                },
                z = function(e) {
                    return G(H(e), C.retry)
                },
                j = function(e) {
                    return G(H(e), C.size)
                },
                V = function(e) {
                    return G(H(e), C.spinner)
                },
                G = function(e, t) {
                    return e && qq(e).getFirstByClass(t)
                },
                X = function(e) {
                    return a && G(H(e), C.thumbnail)
                },
                W = function(e) {
                ...
                Y = function() {
                    ...
                    if (o = qq.trimStr(o), s = document.createElement("div"), s.appendChild(qq.toElement(o)), v = qq(s).getFirstByClass(C.uploader), w.button && (c = qq(s).getFirstByClass(C.button), c && qq(c).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (g = qq(s).getFirstByClass(C.dropProcessing), g && qq(g).remove()), f = qq(s).getFirstByClass(C.drop), f && !qq.DragAndDrop && (t("DnD module unavailable.", "info"), qq(f).remove()), qq.supportedFeatures.fileDrop ? qq(v).hasAttribute(h) && f && (_ = qq(f).getFirstByClass(C.dropText), _ && qq(_).remove()) : (v.removeAttribute(h), f && qq(f).hasAttribute(q) && qq(f).css({
                            display: "none"
                        })), m = qq(s).getFirstByClass(C.thumbnail), a ? m && (y = parseInt(m.getAttribute(d)), y = y > 0 ? y : null, u = qq(m).hasAttribute(p)) : m && qq(m).remove(), a = a && m, n = qq(s).getByClass(C.editFilenameInput).length > 0, i = qq(s).getByClass(C.retry).length > 0, r = qq(s).getFirstByClass(C.list), null == r) throw new Error("Could not find the file list container in the template!");
                    return l = r.innerHTML, r.innerHTML = "", s.getElementsByTagName("DIALOG").length && document.createElement("dialog"), t("Template parsing complete"), {
                        template: qq.trimStr(s.innerHTML),
                ...
                Z = function(e) {
                    ...
                    qq.supportedFeatures.imagePreviews ? o ? w.limits.maxThumbs && w.limits.maxThumbs <= v ? (J(t, o), I()) : A(o).done(function() {
                        x[t] = new qq.Promise, x[t].done(function() {
                            setTimeout(I, w.limits.timeBetweenThumbs)
                        }), null != i ? ne(t, i) : T(t, n, r)
                    }) : I() : o && (A(o), I())
                },
                $ = function(e) {
                    var t = e.id,
                    ...
                    if (o)
                        if (n) {
                            if (!(w.limits.maxThumbs && w.limits.maxThumbs <= v)) return i && A(o), w.imageGenerator.generate(n, o, r).then(function() {
                                te(o), v++, setTimeout(I, w.limits.timeBetweenThumbs)
                            }, function() {
                                J(t, o), setTimeout(I, w.limits.timeBetweenThumbs)
                            });
                            J(t, o), I()
                        } else J(t, o), I()
                },
                ...
                ne = function(e, n) {
                    ...
                    t(qq.format("ID {} is the same file as ID {}.  Will use generated thumbnail from ID {} instead.", e, n, n)), x[n].then(function() {
                        ...
                        x[e].failure(), w.placeholders.waitUntilUpdate || J(e, i)
                    })
                };
            qq.extend(w, e), t = w.log, qq.supportedFeatures.imagePreviews || (w.limits.timeBetweenThumbs = 0, w.limits.maxThumbs = 0), r = w.containerEl, a = void 0 !== w.imageGenerator, o = Y(), F(), qq.extend(this, {
                render: function() {
                    t("Rendering template in DOM."), v = 0, r.innerHTML = o.template, W(B()), this.hideTotalProgress(), s = w.fileContainerEl || G(r, C.list), t("Template rendering complete")
                },
                ...
                addFile: function(e, t, n, i, a) {
                    var u, d = qq.toElement(o.fileTemplate),
                        p = G(d, C.file),
                        q = G(r, C.uploader),
                        f = a ? g.content : s;
                    a && (g.map[e] = d), qq(d).addClass(c + e), q.removeAttribute(h), p && (qq(p).setText(t), p.setAttribute("title", t)), d.setAttribute(l, e), n ? Q(d, n.index, f) : f.appendChild(d), i ? (d.style.display = "none", qq(d).addClass(m)) : (W(L(e)), W(j(e)), W(k(e)), W(z(e)), W(M(e)), W(U(e)), _ && this.hideCancel(e), u = X(e), u && !u.src && P.then(function(e) {
                ...
                addCacheToDom: function() {
                    s.appendChild(g.content), g.content = document.createDocumentFragment(), g.map = {}
                },
                ...
                getEditInput: function(e) {
                    return G(H(e), C.editFilenameInput)
                },
                ...
                uploadPaused: function(e) {
                    this.setStatusText(e, w.text.paused), this.allowContinueButton(e), W(V(e))
                },
                ...
                setStatusText: function(e, t) {
                    var n = G(H(e), C.statusText);
                    n && (null == t ? qq(n).clearText() : qq(n).setText(t))
                },
                hideSpinner: function(e) {
                    qq(H(e)).removeClass(f), W(V(e))
                },
                showSpinner: function(e) {
                    qq(H(e)).addClass(f), te(V(e))
                },
                ...
                hasDialog: function(e) {
                    return qq.supportedFeatures.dialogElement && !!D(e)
                },
                showDialog: function(e, t, n) {
                    var i = D(e),
                        o = G(i, C.dialogMessage),
                        r = i.getElementsByTagName("INPUT")[0],
                        s = G(i, C.dialogCancelButton),
                        a = G(i, C.dialogOkButton),
                        u = new qq.Promise,
                        l = function() {
                            s.removeEventListener("click", c), a && a.removeEventListener("click", d), u.failure()
                        },
                        c = function() {
                            s.removeEventListener("click", c), i.close()
                        },
                        d = function() {
                            i.removeEventListener("close", l), a.removeEventListener("click", d), i.close(), u.success(r && r.value)
                        };
                    return i.addEventListener("close", l), s.addEventListener("click", c), a && a.addEventListener("click", d), r && (r.value = n), o.textContent = t, i.showModal(), u
                }
            })
            ...
            function t(e, t) {
                qq.each(o, function(n, o) {
                    var r, s = n.charAt(0).toUpperCase() + n.slice(1);
                    if (i.templating["is" + s](e)) return r = i.templating.getFileId(e), qq.preventDefault(t), i.log(qq.format("Detected valid file button click event on file '{}', ID: {}.", i.onGetName(r), r)), o(r), !1
                })
            }
            var n = {},
                i = {
            ...
            function o(e, t) {
                var n, o = e.value;
                void 0 !== o && qq.trimStr(o).length > 0 && (n = i(t), void 0 !== n && (o = o + "." + n), a.onSetName(t, o)), a.onEditingStatusChange(t, !1)
            }
            ...
            qq.extend(a, e), a.attachTo = a.templating.getFileList(), qq.extend(this, new qq.UiEventHandler(a, t)), qq.extend(t, {
                handleFilenameEdit: function(e, t, i) {
                    var o = a.templating.getEditInput(e);
                    a.onEditingStatusChange(e, !0), o.value = n(e), i && o.focus(), r(o, e), s(o, e)
                }
            })
        }, qq.CryptoJS = function(e, t) {
            var n = {},
                i = n.lib = {},
                o = i.Base = function() {
                    function e() {}
            ...
            i.Base64 = {
                stringify: function(e) {
                    ...
                    for (var o = [], r = 0; r < n; r += 3)
                        for (var s = t[r >>> 2] >>> 24 - r % 4 * 8 & 255, a = t[r + 1 >>> 2] >>> 24 - (r + 1) % 4 * 8 & 255, u = t[r + 2 >>> 2] >>> 24 - (r + 2) % 4 * 8 & 255, l = s << 16 | a << 8 | u, c = 0; c < 4 && r + .75 * c < n; c++) o.push(i.charAt(l >>> 6 * (3 - c) & 63));
                    var d = i.charAt(64);
                    if (d)
        ...
        function() {
            ...
            r.HMAC = n.extend({
                init: function(e, t) {
                    ...
                    for (var r = this._oKey = t.clone(), s = this._iKey = t.clone(), a = r.words, u = s.words, l = 0; l < n; l++) a[l] ^= 1549556828, u[l] ^= 909522486;
            ...
            var e = qq.CryptoJS,
                ...
                s = o.SHA1 = i.extend({
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var n = this._hash.words, i = n[0], o = n[1], s = n[2], a = n[3], u = n[4], l = 0; l < 80; l++) {
                            if (l < 16) r[l] = 0 | e[t + l];
                            else {
                            ...
                            d += l < 20 ? (o & s | ~o & a) + 1518500249 : l < 40 ? (o ^ s ^ a) + 1859775393 : l < 60 ? (o & s | o & a | s & a) - 1894007588 : (o ^ s ^ a) - 899497514, u = a, a = s, s = o << 30 | o >>> 2, o = i, i = d
                        }
        ...
        function(e) {
            ...
            ! function() {
                ...
                for (var i = 2, o = 0; o < 64;) t(i) && (o < 8 && (s[o] = n(e.pow(i, .5))), a[o] = n(e.pow(i, 1 / 3)), o++), i++
            }();
            var u = [],
                l = r.SHA256 = o.extend({
                    _doReset: function() {
                    ...
                    _doProcessBlock: function(e, t) {
                        for (var n = this._hash.words, i = n[0], o = n[1], r = n[2], s = n[3], l = n[4], c = n[5], d = n[6], p = n[7], q = 0; q < 64; q++) {
                            if (q < 16) u[q] = 0 | e[t + q];
                            else {
                                var h = u[q - 15],
                            ...
                            var _ = l & c ^ ~l & d,
                                ...
                                y = p + S + _ + a[q] + u[q],
                                w = b + v;
                            p = d, d = c, c = l, l = s + y | 0, s = r, r = o, o = i, i = y + w | 0
                        }
                        n[0] = n[0] + i | 0, n[1] = n[1] + o | 0, n[2] = n[2] + r | 0, n[3] = n[3] + s | 0, n[4] = n[4] + l | 0, n[5] = n[5] + c | 0, n[6] = n[6] + d | 0, n[7] = n[7] + p | 0
                    },
                    _doFinalize: function() {
                        var t = this._data,
                            n = t.words,
        ...
        function() {
            ...
            return {
                ...
                _getPrefixedParamName: function(e) {
                    return qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, e) >= 0 ? e : qq.s3.util.AWS_PARAM_PREFIX + e
                },
                getPolicy: function(e) {
                    var t = {},
                        ...
                        d = e.sessionToken,
                        p = e.params,
                        q = qq.s3.util.getSuccessRedirectAbsoluteUrl(e.successRedirectUrl),
                        h = e.minFileSize,
                        f = e.maxFileSize,
                        m = e.reducedRedundancy,
                        g = e.region,
                        _ = e.serverSideEncryption,
                        v = e.signatureVersion;
                    return t.expiration = qq.s3.util.getPolicyExpirationDate(o, r), n.push({
                        acl: u
                    }), n.push({
                        bucket: i
                    }), l && n.push({
                        ...
                        success_action_status: c.toString()
                    }), q && n.push({
                        success_action_redirect: q
                    }), m && (n.push({}), n[n.length - 1][qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE), d && (n.push({}), n[n.length - 1][qq.s3.util.SESSION_TOKEN_PARAM_NAME] = d), _ && (n.push({}), n[n.length - 1][qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE), 2 === v ? n.push({
                        key: s
                    }) : 4 === v && (n.push({}), n[n.length - 1][qq.s3.util.ALGORITHM_PARAM_NAME] = qq.s3.util.V4_ALGORITHM_PARAM_VALUE, n.push({}), n[n.length - 1].key = s, n.push({}), n[n.length - 1][qq.s3.util.CREDENTIAL_PARAM_NAME] = qq.s3.util.getV4CredentialsString({
                        date: o,
                        key: a,
                        region: g
                    }), n.push({}), n[n.length - 1][qq.s3.util.DATE_PARAM_NAME] = qq.s3.util.getV4PolicyDate(o, r)), qq.each(p, function(e, t) {
                        var i = qq.s3.util._getPrefixedParamName(e),
                            o = {};
                        qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, i) >= 0 ? o[i] = t : o[i] = encodeURIComponent(t), n.push(o)
                ...
                generateAwsParams: function(e, t) {
                    var n, i = {},
                        ...
                        g = e.signatureVersion,
                        _ = new Date,
                        v = e.log;
                    return e.date = _, n = qq.s3.util.getPolicy(e), i.key = l, u && (i["Content-Type"] = u), p && (i.success_action_status = p), q && (i.success_action_redirect = q), h && (i[qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE), m && (i[qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE), s && (i[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = s), i.acl = d, qq.each(o, function(e, t) {
                        var n = qq.s3.util._getPrefixedParamName(e);
                        qq.indexOf(qq.s3.util.UNPREFIXED_PARAM_NAMES, n) >= 0 ? i[n] = t : i[n] = encodeURIComponent(t)
                    }), 2 === g ? i.AWSAccessKeyId = c : 4 === g && (i[qq.s3.util.ALGORITHM_PARAM_NAME] = qq.s3.util.V4_ALGORITHM_PARAM_VALUE, i[qq.s3.util.CREDENTIAL_PARAM_NAME] = qq.s3.util.getV4CredentialsString({
                        date: _,
                        key: c,
                        region: f
                    }), i[qq.s3.util.DATE_PARAM_NAME] = qq.s3.util.getV4PolicyDate(_, a)), t(n).then(function(t, n, o) {
                        ...
                        e = e || "Can't continue further with request to S3 as we did not receive a valid signature and policy from the server.", v("Policy signing failed.  " + e, "error"), r.failure(e)
                    }), r
                },
                ...
                getPolicyExpirationDate: function(e, t) {
                    var n = new Date(e.getTime() + t);
                    return qq.s3.util.getPolicyDate(n, 5)
                },
                ...
                getV4PolicyDate: function(e, t) {
                    var n = new Date(e.getTime() + t);
                    return qq.s3.util.getCredentialsDate(n) + "T" + ("0" + n.getUTCHours()).slice(-2) + ("0" + n.getUTCMinutes()).slice(-2) + ("0" + n.getUTCSeconds()).slice(-2) + "Z"
                },
            ...
            qq.nonTraditionalBasePublicApi = {
                ...
                _onComplete: function(e, t, n, i) {
                    var o, r, s = !!n.success,
                        ...
                        q = new qq.Promise,
                        h = this._uploadSuccessParamsStore.get(e),
                        f = this._paramsStore.get(e),
                        m = function(t) {
                            delete a._failedSuccessRequestCallbacks[e], qq.extend(n, t), qq.FineUploaderBasic.prototype._onComplete.apply(a, u), q.success(t)
                        },
                        g = function(r) {
                            var s = o;
                            qq.extend(n, r), n && n.reset && (s = null), s ? a._failedSuccessRequestCallbacks[e] = s : delete a._failedSuccessRequestCallbacks[e], a._onAutoRetry(e, t, n, i, s) || (qq.FineUploaderBasic.prototype._onComplete.apply(a, u), q.failure(r))
                        };
                    return s && l ? (r = new qq.UploadSuccessAjaxRequester({
                        endpoint: l,
                        method: d,
                        customHeaders: c,
                        cors: p,
                        log: qq.bind(this.log, this)
                    }), qq.extend(h, a._getEndpointSpecificParams(e, n, i), !0), f && qq.extend(h, f, !0), o = qq.bind(function() {
                        r.sendSuccessRequest(e, h).then(m, g)
                    }, a), o(), q) : qq.FineUploaderBasic.prototype._onComplete.apply(this, arguments)
                },
        ...
        function() {
            ...
            qq.s3.FineUploaderBasic = function(e) {
                        ...
                        return {
                            get: function(t) {
                                ...
                                return qq.each(n, function(e, t) {
                                    var n = e;
                                    qq.indexOf(qq.s3.util.CASE_SENSITIVE_PARAM_NAMES, n) < 0 && (n = n.toLowerCase()), i[n] = qq.isFunction(t) ? t() : t
                                }), i
                            }
                        }
                        ...
                        onExpired: function() {
                            ...
                            return qq.isGenericPromise(n) ? n.then(function(n) {
                                try {
                                    ...
                                    e.log("Invalid credentials returned from onCredentialsExpired callback! (" + n.message + ")", "error"), t.failure("onCredentialsExpired did not return valid credentials.")
                                }
                            }, function(n) {
                ...
                _determineKeyName: function(e, t) {
                    ...
                    switch (i) {
                        ...
                        case "filename":
                            ...
                            break;
                        default:
                            qq.isFunction(i) ? this._handleKeynameFunction(i, e, s, r) : (this.log(i + " is not a valid value for the s3.keyname option!", "error"), r())
                    }
                    return n
                },
                _handleKeynameFunction: function(e, t, n, i) {
                    var o = this,
                        ...
                        a = e.call(this, t);
                    qq.isGenericPromise(a) ? a.then(r, s) : null == a ? s() : r(a)
                },
            ...
            function n(e, t, n) {
                var i, o, r, s = new qq.Promise,
                    ...
                    f = function(e) {
                        ...
                        return qq.each(e.headers, function(e) {
                            l.push(e)
                        }), l.sort(), qq.each(l, function(t, i) {
                            qq.indexOf(qq.s3.util.UNSIGNABLE_REST_HEADER_NAMES, i) < 0 ? d += i.toLowerCase() + ":" + e.headers[i].trim() + "\n" : "Content-MD5" === i ? n = e.headers[i] : s.unshift(t)
                        }), qq.each(s, function(e, t) {
                            l.splice(t, 1)
                        }), o = {
                            bucket: e.bucket,
                            contentMd5: n,
                            ...
                            date: h,
                            drift: c.signatureSpec.drift,
                            endOfUrl: i,
                            hashedContent: e.hashedContent,
                            headerNames: l,
                            headersStr: d,
                            method: a
                        }, r = 2 === t ? p.getStringToSign(o) : q.getStringToSign(o), {
                            date: h,
                            endOfUrl: i,
                            signedHeaders: 4 === t ? q.getSignedHeaders(o.headerNames) : null,
                ...
                switch (n.type) {
                    case u.REQUEST_TYPE.MULTIPART_ABORT:
                        a = "DELETE", i = qq.format("uploadId={}", n.uploadId);
                        break;
                    ...
                    case u.REQUEST_TYPE.MULTIPART_UPLOAD:
                        a = "PUT", i = qq.format("partNumber={}&uploadId={}", n.partNum, n.uploadId)
                }
                return i = n.key + "?" + i, 4 === t ? q.getEncodedHashedPayload(n.content).then(function(e) {
                    n.headers["x-amz-content-sha256"] = e, n.headers.Host = n.host, n.headers["x-amz-date"] = qq.s3.util.getV4PolicyDate(h, c.signatureSpec.drift), n.hashedContent = e, s.success(f(n))
                }) : s.success(f(n)), s
            }

            function i(e, t, n, i, s) {
                var a;
                t.signatureConstructor ? (s && (a = t.signatureConstructor.getHeaders(), a[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = s, t.signatureConstructor.withHeaders(a)), t.signatureConstructor.getToSign(e).then(function(e) {
                    r(t.signatureConstructor, e.stringToSign, n)
                })) : (s && qq.s3.util.refreshPolicyCredentials(t, s), o(t, n, i, s))
            }

            function o(e, t, n, i) {
                4 === c.signatureSpec.version ? q.signPolicy(e, t, n, i) : p.signPolicy(e, t, n, i)
            }

            function r(e, t, n) {
                4 === c.signatureSpec.version ? q.signApiRequest(e, t, n) : p.signApiRequest(e, t, n)
            }
            var s, a, u = this,
                l = {},
                c = {
                ...
                p = {
                    ...
                    signApiRequest: function(e, t, n) {
                        var i = qq.CryptoJS.enc.Utf8.parse(t),
                            o = qq.CryptoJS.HmacSHA1(i, a.get().secretKey),
                            r = qq.CryptoJS.enc.Base64.stringify(o);
                        d(e, r, n)
                    },
                    signPolicy: function(e, t, n, i) {
                        var o = JSON.stringify(e),
                            r = qq.CryptoJS.enc.Utf8.parse(o),
                            s = qq.CryptoJS.enc.Base64.stringify(r),
                            u = qq.CryptoJS.HmacSHA1(s, a.get().secretKey),
                            l = qq.CryptoJS.enc.Base64.stringify(u);
                        t.success({
                            policy: s,
                            signature: l
                        }, n, i)
                ...
                q = {
                        ...
                        return qq.isBlob(e) ? (t = new FileReader, t.onloadend = function(e) {
                            if (e.target.readyState === FileReader.DONE)
                                if (e.target.error) n.failure(e.target.error);
                                    ...
                                    var t = qq.CryptoJS.lib.WordArray.create(e.target.result);
                                    n.success(qq.CryptoJS.SHA256(t).toString())
                                }
                        }, t.readAsArrayBuffer(e)) : (e = e || "", n.success(qq.CryptoJS.SHA256(e).toString())), n
                    },
                    getScope: function(e, t) {
                        return qq.s3.util.getCredentialsDate(e) + "/" + t + "/s3/aws4_request"
                    },
                    getStringToSign: function(e) {
                        var t = q.getCanonicalRequest(e),
                            n = qq.s3.util.getV4PolicyDate(e.date, e.drift),
                            i = qq.CryptoJS.SHA256(t).toString(),
                            o = q.getScope(e.date, c.signatureSpec.region),
                            r = "AWS4-HMAC-SHA256\n{}\n{}\n{}";
                        return {
                    ...
                    signApiRequest: function(e, t, n) {
                        var i, o, r, s, u = a.get().secretKey,
                            l = /.+\n.+\n(\d+)\/(.+)\/s3\/.+\n(.+)/,
                            c = l.exec(t);
                        i = qq.CryptoJS.HmacSHA256(c[1], "AWS4" + u), o = qq.CryptoJS.HmacSHA256(c[2], i), r = qq.CryptoJS.HmacSHA256("s3", o), s = qq.CryptoJS.HmacSHA256("aws4_request", r), d(e, qq.CryptoJS.HmacSHA256(t, s), n)
                    },
                    signPolicy: function(e, t, n, i) {
                        var o, r, s, u, l, c = JSON.stringify(e),
                            d = qq.CryptoJS.enc.Utf8.parse(c),
                            p = qq.CryptoJS.enc.Base64.stringify(d),
                            q = a.get().secretKey,
                            h = /.+\/(.+)\/(.+)\/s3\/aws4_request/,
                            f = function() {
                                var t = null;
                        ...
                        o = h.exec(f), r = qq.CryptoJS.HmacSHA256(o[1], "AWS4" + q), s = qq.CryptoJS.HmacSHA256(o[2], r), u = qq.CryptoJS.HmacSHA256("s3", s), l = qq.CryptoJS.HmacSHA256("aws4_request", u), t.success({
                            policy: p,
                            signature: qq.CryptoJS.HmacSHA256(p, l).toString()
                        }, n, i)
                    }
                };
            qq.extend(c, e, !0), a = c.signatureSpec.credentialsProvider, s = qq.extend(this, new qq.AjaxRequester({
                acceptHeader: "application/json",
                method: c.method,
                ...
                getSignature: function(e, t) {
                    ...
                    return 4 === c.signatureSpec.version && (n = {
                        v4: !0
                    }), a.get().secretKey && qq.CryptoJS ? a.get().expiration.getTime() > Date.now() ? i(e, t, u) : a.onExpired().then(function() {
                        i(e, t, u, a.get().accessKey, a.get().sessionToken)
                    }, function(e) {
                        ...
                        }, s.initTransport(e).withParams(o).withQueryParams(n).send()
                    }) : s.initTransport(e).withParams(o).withQueryParams(n).send(), l[e] = {
                        promise: u,
                ...
                constructStringToSign: function(e, t, i, o) {
                    ...
                    return {
                        ...
                        getToSign: function(q) {
                            var h = a.get().sessionToken,
                                f = new qq.Promise,
                                m = new Date(Date.now() + c.signatureSpec.drift);
                            return p["x-amz-date"] = m.toUTCString(), h && (p[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = h), n(q, c.signatureSpec.version, {
                                bucket: t,
                                content: s,
                                contentType: u,
                                headers: p,
            ...
            function t(e, t, n) {
                ...
                delete i[e], o.log(qq.format("Received the following response body to an upload success request for id {}: {}", e, a));
                try {
                    r = qq.parseJson(a), n || r && (r.error || r.success === !1) ? (o.log("Upload success request was rejected by the server.", "error"), s.failure(qq.extend(r, l))) : (o.log("Upload success was acknowledged by the server."), s.success(qq.extend(r, u)))
                } catch (t) {
                    n ? (o.log(qq.format("Your server indicated failure in its upload success request response for id {}!", e), "error"), s.failure(l)) : (o.log("Upload success was acknowledged by the server."), s.success(u))
                }
            }
            var n, i = [],
                o = {
            ...
            qq.extend(s, e), o = new qq.s3.RequestSigner({
                ...
                send: function(e) {
                    ...
                    return t(e).then(function(t, o) {
                        s.log("Submitting S3 initiate multipart upload request for " + e), r[e] = n, i.initTransport(e).withPath(o).withHeaders(t).send()
                    }, n.failure), n
                }
            })
            ...
            function t(e, t, n) {
                var i = new qq.Promise,
                    o = a.getBucket(e),
                    s = a.getHost(e),
                    u = r.constructStringToSign(r.REQUEST_TYPE.MULTIPART_COMPLETE, o, s, a.getKey(e)).withUploadId(t).withContent(n).withContentType("application/xml; charset=UTF-8");
            ...
            function i(e) {
                ...
                return e.sort(function(e, t) {
                    ...
                    var i = n.part,
                        ...
                        s = t.createElement("PartNumber"),
                        a = t.createTextNode(i),
                        u = t.createTextNode(o),
                        l = t.createElement("ETag");
                    l.appendChild(u), s.appendChild(a), r.appendChild(s), r.appendChild(l), qq(t).children()[0].appendChild(r)
            ...
            qq.extend(a, e), r = new qq.s3.RequestSigner({
                ...
                send: function(e, n, r) {
                    ...
                    return t(e, n, l).then(function(t, n) {
                        a.log("Submitting S3 complete multipart upload request for " + e), s[e] = u, delete t["Content-Type"], o.initTransport(e).withPath(n).withHeaders(t).withPayload(l).send()
                    }, u.failure), u
                }
            })
            ...
            function t(e, t) {
                var n = new qq.Promise,
                    i = r.getBucket(e),
                    s = r.getHost(e),
                    a = o.constructStringToSign(o.REQUEST_TYPE.MULTIPART_ABORT, i, s, r.getKey(e)).withUploadId(t);
            ...
            function n(e, t, n) {
                var i, o = new DOMParser,
                    s = o.parseFromString(t.responseText, "application/xml"),
                    a = s.getElementsByTagName("Error");
            ...
            var n = t.getName,
                ...
                d = e.endpointStore,
                p = e.aclStore,
                q = e.objectProperties.reducedRedundancy,
                ...
                _ = this,
                v = e.signature.credentialsProvider,
                b = {
                    combine: function(e) {
                        var t = _._getPersistableData(e).uploadId,
                            n = _._getPersistableData(e).etags,
                            i = new qq.Promise;
                        return S.completeMultipart.send(e, t, n).then(i.success, function(t, n) {
                            i.failure(w.done(e, n).response, n)
                        }), i
                    },
                    done: function(e, t, n) {
                        var i, o = w.response.parse(e, t);
                        o.success && (i = t.getResponseHeader("ETag"), _._getPersistableData(e).etags || (_._getPersistableData(e).etags = []), _._getPersistableData(e).etags.push({
                            part: n + 1,
                            etag: i
                        }))
                    },
                    initHeaders: function(e, t, n) {
                        var i = w.bucket.getName(e),
                            o = w.host.getName(e),
                            r = w.key.urlSafe(e),
                            s = new qq.Promise,
                            a = S.restSignature.constructStringToSign(S.restSignature.REQUEST_TYPE.MULTIPART_UPLOAD, i, o, r).withPartNum(t + 1).withContent(n).withUploadId(_._getPersistableData(e).uploadId);
                        return S.restSignature.getSignature(e + "." + t, {
                            signatureConstructor: a
                        }).then(s.success, s.failure), s
                    },
                    put: function(t, n) {
                        var o = _._createXhr(t, n),
                            r = _._getChunkData(t, n),
                            s = e.endpointStore.get(t),
                            a = new qq.Promise;
                        return b.initHeaders(t, n, r.blob).then(function(e, u) {
                            if (o._cancelled) i(qq.format("Upload of item {}.{} cancelled. Upload will not start after successful signature request.", t, n)), a.failure({
                                error: "Chunk upload cancelled"
                            });
                            else {
                                var l = s + "/" + u;
                                _._registerProgressHandler(t, n, r.size), w.track(t, o, n).then(a.success, a.failure), o.open("PUT", l, !0), qq.each(e, function(e, t) {
                                    o.setRequestHeader(e, t)
                                }), o.send(r.blob)
                            }
                        }, function() {
                    ...
                    send: function(e, t) {
                        var n = new qq.Promise;
                        return b.setup(e).then(function() {
                            b.put(e, t).then(n.success, n.failure)
                        }, function(e, t) {
                            n.failure({
                                error: e
                            }, t)
                    ...
                    setup: function(e) {
                        var t = new qq.Promise,
                            n = _._getPersistableData(e).uploadId,
                            i = new qq.Promise;
                        return n ? n instanceof qq.Promise ? n.then(function(e) {
                            t.success(e)
                        }) : t.success(n) : (_._getPersistableData(e).uploadId = i, S.initiateMultipart.send(e).then(function(n) {
                            _._getPersistableData(e).uploadId = n, i.success(n), t.success(n)
                        }, function(n, o) {
                            _._getPersistableData(e).uploadId = null, t.failure(n, o), i.failure(n, o)
                        })), t
                    }
                },
                S = {
                    abortMultipart: new qq.s3.AbortMultipartAjaxRequester({
                        ...
                        log: i,
                        getBucket: function(e) {
                            return w.bucket.getName(e)
                        },
                        getHost: function(e) {
                            return w.host.getName(e)
                        },
                        getKey: function(e) {
                            return w.key.urlSafe(e)
                        }
                    }),
                ...
                y = {
                    initParams: function(e) {
                        var t = c.get(e);
                        return t[l] = n(e), qq.s3.util.generateAwsParams({
                            endpoint: d.get(e),
                            clockDrift: o,
                            params: t,
                            type: _._getMimeType(e),
                            bucket: w.bucket.getName(e),
                            key: _.getThirdPartyFileId(e),
                            accessKey: v.get().accessKey,
                            sessionToken: v.get().sessionToken,
                            acl: p.get(e),
                            expectedStatus: r,
                            ...
                            region: h,
                            serverSideEncryption: f,
                            signatureVersion: g.version,
                            log: i
                        }, qq.bind(S.policySignature.getSignature, this, e))
                    },
                    send: function(e) {
                        var t = new qq.Promise,
                            n = _._createXhr(e),
                            o = _.getFile(e);
                        return _._registerProgressHandler(e), w.track(e, n).then(t.success, t.failure), y.setup(e, n, o).then(function(t) {
                    ...
                    setup: function(e, t, n) {
                        var i = new FormData,
                            ...
                            r = o,
                            s = new qq.Promise;
                        return y.initParams(e).then(function(e) {
                            t.open("POST", r, !0), qq.obj2FormData(e, i), i.append("file", n), s.success(i)
                        }, function(e) {
                            s.failure({
                                error: e
                            })
                ...
                w = {
                    bucket: {
                        promise: function(e) {
                            var t = new qq.Promise,
                                n = _._getFileState(e).bucket;
                            return n ? t.success(n) : s(e).then(function(n) {
                                _._getFileState(e).bucket = n, t.success(n)
                            }, t.failure), t
                        },
                        getName: function(e) {
                            return _._getFileState(e).bucket
                        }
                    },
                    host: {
                        promise: function(e) {
                            var t = new qq.Promise,
                                n = _._getFileState(e).host;
                            return n ? t.success(n) : a(e).then(function(n) {
                                _._getFileState(e).host = n, t.success(n)
                            }, t.failure), t
                        },
                        getName: function(e) {
                            return _._getFileState(e).host
                        }
                    },
                    done: function(e, t) {
                        var n = w.response.parse(e, t),
                            o = n.success !== !0;
                        return o && w.response.shouldReset(n.code) && (i("This is an unrecoverable error, we must restart the upload entirely on the next retry attempt.", "error"), n.reset = !0), {
                            success: !o,
                            response: n
                        }
                    },
                    key: {
                        promise: function(e) {
                            var t = new qq.Promise,
                                i = _.getThirdPartyFileId(e);
                            return null == i ? (_._setThirdPartyFileId(e, t), u(e, n(e)).then(function(n) {
                                _._setThirdPartyFileId(e, n), t.success(n)
                            }, function(n) {
                                _._setThirdPartyFileId(e, null), t.failure(n)
                            })) : qq.isGenericPromise(i) ? i.then(t.success, t.failure) : t.success(i), t
                        },
                        urlSafe: function(e) {
                            var t = encodeURIComponent(_.getThirdPartyFileId(e));
                    ...
                    response: {
                        parse: function(e, t) {
                            var n, o = {};
                            try {
                                i(qq.format("Received response status {} with body: {}", t.status, t.responseText)), t.status === r ? o.success = !0 : (n = w.response.parseError(t.responseText), n && (o.error = n.message, o.code = n.code))
                            } catch (e) {
                        ...
                        parseError: function(e) {
                            var t, n, i = new DOMParser,
                                ...
                                s = {};
                            if (r.length) return t = o.getElementsByTagName("Code"), n = o.getElementsByTagName("Message"), n.length && (s.message = n[0].textContent), t.length && (s.code = t[0].textContent), s
                        },
                    ...
                    start: function(e, t) {
                        var n = new qq.Promise;
                        return w.key.promise(e).then(function() {
                            w.bucket.promise(e).then(function() {
                                w.host.promise(e).then(function() {
                                    null == t ? y.send(e).then(n.success, n.failure) : b.send(e, t).then(n.success, n.failure)
                                })
                            })
                        }, function(e) {
                            n.failure({
                    ...
                    track: function(e, t, n) {
                        ...
                        return t.onreadystatechange = function() {
                            if (4 === t.readyState) {
                                var o;
                                null == n ? (o = w.done(e, t), i[o.success ? "success" : "failure"](o.response, t)) : (b.done(e, t, n), o = w.done(e, t), i[o.success ? "success" : "failure"](o.response, t))
                            }
                        }, i
                    }
                };
            qq.extend(this, {
                ...
                return {
                    expunge: function(t) {
                        var n = _._getPersistableData(t) && _._getPersistableData(t).uploadId,
                            i = _._maybeDeletePersistedChunkData(t);
                        void 0 !== n && i && S.abortMultipart.send(t, n), e.expunge(t)
                    },
            ...
            function n(t, n) {
                var i, o, r, s = (e.endpointStore.get(t), a._getFileState(t).bucket);
                try {
                    if (i = n.contentDocument || n.contentWindow.document, o = i.body.innerHTML, r = qq.s3.util.parseIframeResponse(n), r.bucket === s && r.key === qq.s3.util.encodeQueryStringParam(a.getThirdPartyFileId(t))) return !0;
                    p("Response from AWS included an unexpected bucket or key name.", "error")
                } catch (e) {
                    p("Error when attempting to parse form upload response (" + e.message + ")", "error")
                }
                return !1
            }
            ...
            function i(e) {
                var t = m.get(e);
                return t[f] = c(e), qq.s3.util.generateAwsParams({
                    endpoint: g.get(e),
                    clockDrift: u,
                    params: t,
                    bucket: a._getFileState(e).bucket,
                    key: a.getThirdPartyFileId(e),
                    accessKey: x.get().accessKey,
                    sessionToken: x.get().sessionToken,
                    acl: _.get(e),
                    minFileSize: y.minSizeLimit,
                    maxFileSize: y.maxSizeLimit,
                    successRedirectUrl: C,
                    reducedRedundancy: v,
                    region: b,
                    serverSideEncryption: S,
                    signatureVersion: w.version,
                    log: p
                }, qq.bind(E.getSignature, this, e))
            }
            ...
            function r(e) {
                var t = a._createIframe(e),
                    i = a.getInput(e),
                    r = new qq.Promise;
                return o(e, t).then(function(o) {
                    o.appendChild(i), a._attachLoadEvent(t, function(i) {
                        p("iframe loaded"), i ? i.success === !1 && (p("Amazon likely rejected the upload request", "error"), r.failure(i)) : (i = {}, i.success = n(e, t), i.success === !1 ? (p("A success response was received by Amazon, but it was invalid in some way.", "error"), r.failure(i)) : (qq.extend(i, qq.s3.util.parseIframeResponse(t)), r.success(i))), s(e, t)
                    }), p("Sending upload request for " + e), o.submit(), qq(o).remove()
                }, r.failure), r
            }

            function s(e, t) {
                a._detachLoadEvent(e), t && qq(t).remove()
            }
            var a = this,
                u = e.clockDrift,
                l = t.onUuidChanged,
                ...
                g = e.endpointStore,
                _ = e.aclStore,
                v = e.objectProperties.reducedRedundancy,
                b = e.objectProperties.region,
                S = e.objectProperties.serverSideEncryption,
                y = e.validation,
                w = e.signature,
                C = e.iframeSupport.localBlankPagePath,
                x = e.signature.credentialsProvider,
                E = new qq.s3.RequestSigner({
                    signatureSpec: w,
                    cors: e.cors,
                    log: p
                });
            if (void 0 === C) throw new Error("successRedirectEndpoint MUST be defined if you intend to use browsers that do not support the File API!");
            qq.extend(this, new qq.FormUploadHandler({
                options: {
                    isCors: !1,
                    inputName: "file"
                ...
                uploadFile: function(e) {
                    var t = c(e),
                        n = new qq.Promise;
                    return a.getThirdPartyFileId(e) ? a._getFileState(e).bucket ? r(e).then(n.success, n.failure) : q(e).then(function(t) {
                        a._getFileState(e).bucket = t, r(e).then(n.success, n.failure)
                    }) : h(e, t).then(function(t) {
                        q(e).then(function(i) {
                            a._getFileState(e).bucket = i, a._setThirdPartyFileId(e, t), r(e).then(n.success, n.failure)
                        }, function(e) {
                            n.failure({
                                error: e
                            })
        ...
        }(), qq.azure = qq.azure || {}, qq.azure.util = qq.azure.util || function() {
            "use strict";
            return {
                AZURE_PARAM_PREFIX: "x-ms-meta-",
                _paramNameMatchesAzureParameter: function(e) {
                    switch (e) {
                        case "Cache-Control":
                ...
                _getPrefixedParamName: function(e) {
                    return qq.azure.util._paramNameMatchesAzureParameter(e) ? e : qq.azure.util.AZURE_PARAM_PREFIX + e
                },
                getParamsAsHeaders: function(e) {
                    var t = {};
                    return qq.each(e, function(e, n) {
                        var i = qq.azure.util._getPrefixedParamName(e),
                            o = null;
                        qq.isFunction(n) ? o = String(n()) : qq.isObject(n) ? qq.extend(t, qq.azure.util.getParamsAsHeaders(n)) : o = String(n), null !== o && (qq.azure.util._paramNameMatchesAzureParameter(e) ? t[i] = o : t[i] = encodeURIComponent(o))
                    }), t
                },
                parseAzureError: function(e, t) {
                    var n, i, o = new DOMParser,
                        r = o.parseFromString(e, "application/xml"),
                        s = r.getElementsByTagName("Error")[0],
                        a = {};
                    if (t("Received error response: " + e, "error"), s) return i = s.getElementsByTagName("Message")[0], i && (a.message = i.textContent), n = s.getElementsByTagName("Code")[0], n && (a.code = n.textContent), t("Parsed Azure error: " + JSON.stringify(a), "error"), a
                }
            }
        }(),
        function() {
        ...
        function() {
            ...
            qq.azure.FineUploaderBasic = function(e) {
                ...
                qq.extend(t, e, !0), qq.FineUploaderBasic.call(this, t), this._uploadSuccessParamsStore = this._createStore(this._options.uploadSuccess.params), this._uploadSuccessEndpointStore = this._createStore(this._options.uploadSuccess.endpoint), this._failedSuccessRequestCallbacks = {}, this._cannedBlobNames = {}
                ...
                _determineBlobName: function(e) {
                    var t = this._options.blobProperties.name,
                        n = this.getUuid(e),
                        i = this.getName(e),
                        o = qq.getExtension(i),
                        r = n;
                    ...
                    switch (t) {
                        case "uuid":
                            return void 0 !== o && (r += "." + o), (new qq.Promise).success(r);
                        case "filename":
                ...
                _addCannedFile: function(e) {
                    ...
                    return t = qq.FineUploaderBasic.prototype._addCannedFile.apply(this, arguments), this._cannedBlobNames[t] = e.blobName, t
                },
                _deleteBlob: function(e, t) {
                    var n = this,
                        ...
                        a = function(t, i, o) {
                            e ? (n.log("Will cancel upload, but cannot remove uncommitted parts from Azure due to issue retrieving SAS", "error"), qq.FineUploaderBasic.prototype._onCancel.call(n, t, n.getName(t))) : (n._onDeleteComplete(t, o, !0), n._options.callbacks.onDeleteComplete(t, o, !0))
                        },
                        u = new qq.azure.DeleteBlob({
                            endpointStore: r,
                            log: qq.bind(n.log, n),
                            onDelete: function(e) {
                            ...
                            onDeleteComplete: function(t, o, r) {
                                delete i[t], r && (e ? n.log("Will cancel upload, but failed to remove uncommitted parts from Azure.", "error") : qq.azure.util.parseAzureError(o.responseText, qq.bind(n.log, n))), e ? (qq.FineUploaderBasic.prototype._onCancel.call(n, t, n.getName(t)), n.log("Deleted uncommitted blob chunks for " + t)) : (n._onDeleteComplete(t, o, r), n._options.callbacks.onDeleteComplete(t, o, r))
                            }
                        }),
                        l = new qq.azure.GetSas({
                            cors: this._options.cors,
                            endpointStore: {
                                get: function() {
                            ...
                            restRequestVerb: u.method,
                            log: qq.bind(n.log, n)
                        });
                    l.request(t, o.get(t)).then(qq.bind(s, n, t), qq.bind(a, n, t))
                },
                _createDeleteHandler: function() {
                    var e = this;
                    return {
            ...
            function n(e) {
                ...
                return o(e).then(function(n) {
                    var i = s._getMimeType(e),
                        o = s._getPersistableData(e).blockIdEntries;
                    v.putBlockList.send(e, n, o, i, function(t) {
                        s._registerXhr(e, null, t, v.putBlockList)
                    }).then(function(n) {
                        a("Success combining chunks for id " + e), t.success({}, n)
                    }, function(n) {
                        a("Attempt to combine chunks failed for id " + e, "error"), r(n, t)
                    })
                }, t.failure), t
            }
            ...
            function i(e) {
                var t = l.get(e),
                    n = new qq.Promise,
                    i = function(i) {
                        s._setThirdPartyFileId(e, i), n.success(t + "/" + i)
                    },
                    o = function(e) {
                        n.failure(e)
                    };
                return f(e).then(i, o), n
            }
            ...
            function o(e, t) {
                var n = null == t ? e : e + "." + t,
                    o = new qq.Promise,
                    r = function(e) {
                        a("GET SAS request succeeded."), o.success(e)
                    },
                    s = function(e, t) {
                        a("GET SAS request failed: " + e, "error"), o.failure({
                            error: "Problem communicating with local server"
                        }, t)
                    },
                    u = function(e) {
                        v.getSasForPutBlobOrBlock.request(n, e).then(r, s)
                    },
                    l = function(t) {
                        a(qq.format("Failed to determine blob name for ID {} - {}", e, t), "error"), o.failure({
                            error: t
                        })
                    };
                return i(e).then(u, l), o
            }

            function r(e, t) {
                var n = qq.azure.util.parseAzureError(e.responseText, a),
                    i = "Problem sending file to Azure";
                t.failure({
                    error: i,
            ...
            qq.extend(this, {
                uploadChunk: function(e, t) {
                    var n = new qq.Promise;
                    return o(e, t).then(function(i) {
                        var o = s._createXhr(e, t),
                            u = s._getChunkData(e, t);
                        s._registerProgressHandler(e, t, u.size), s._registerXhr(e, t, o, v.putBlock), v.putBlock.upload(e + "." + t, o, i, t, u.blob).then(function(t) {
                            s._getPersistableData(e).blockIdEntries || (s._getPersistableData(e).blockIdEntries = []), s._getPersistableData(e).blockIdEntries.push(t), a("Put Block call succeeded for " + e), n.success({}, o)
                        }, function() {
                            a(qq.format("Put Block call failed for ID {} on part {}", e, t), "error"), r(o, n)
                        })
                    }, n.failure), n
                },
                uploadFile: function(e) {
                    ...
                    return o(e).then(function(i) {
                        var o = s._createXhr(e);
                        s._registerProgressHandler(e), v.putBlob.upload(e, o, i, n).then(function() {
                            a("Put Blob call succeeded for " + e), t.success({}, o)
                        }, function() {
                            a("Put Blob call failed for " + e, "error"), r(o, t)
                        })
                    }, t.failure), t
                }
            }), qq.extend(this, new qq.XhrUploadHandler({
                ...
                return {
                    expunge: function(t) {
                        var n = s._wasCanceled(t),
                            i = s._getPersistableData(t),
                            o = i && i.blockIdEntries || [];
                        n && o.length > 0 && h(t), e.expunge(t)
                    },
                    finalizeChunks: function(e) {
                        return n(e)
                    },
                    _shouldChunkThisFile: function(t) {
                        var n = e._shouldChunkThisFile(t);
                        return n && g(t) >= q
                    }
                }
            })
            ...
            function t(e, t, n) {
                var i = o[e];
                n ? i.failure("Received response code " + t.status, t) : t.responseText.length ? i.success(t.responseText) : i.failure("Empty response.", t), delete o[e]
            }
            var n, i = {
                    cors: {
                        expected: !1,
            ...
            qq.extend(i, e), n = qq.extend(this, new qq.AjaxRequester({
                ...
                request: function(e, t) {
                    var r = new qq.Promise,
                        s = i.restRequestVerb;
                    return i.log(qq.format("Submitting GET SAS request for a {} REST request related to file ID {}.", s, e)), o[e] = r, n.initTransport(e).withParams({
                        bloburi: t,
                        _method: s
            ...
            qq.extend(i, e), t = qq.extend(this, new qq.AjaxRequester({
                ...
                customHeaders: function(e) {
                    var t = i.getBlobMetadata(e),
                        n = qq.azure.util.getParamsAsHeaders(t);
                ...
                onComplete: function(e, t, n) {
                    var i = r[e];
                    delete o[e], delete r[e], n ? i.failure() : i.success()
                }
            })), qq.extend(this, {
                method: n,
                upload: function(e, n, s, a) {
                    var u = new qq.Promise;
                    return i.log("Submitting Put Blob request for " + e), r[e] = u, o[e] = s, t.initTransport(e).withPayload(a).withHeaders({
                        "Content-Type": a.type
                    }).send(n), u
                }
            })
            ...
            qq.extend(s, e), n = qq.extend(this, new qq.AjaxRequester({
                validMethods: [i],
                method: i,
                successfulResponseCodes: function() {
                    var e = {};
                ...
                onComplete: function(e, t, n) {
                    var i = r[e],
                        s = o[e];
                    delete a[e], delete r[e], delete o[e], n ? i.failure() : i.success(s)
                }
            })), qq.extend(this, {
                method: i,
                upload: function(e, i, u, l, c) {
                    var d = new qq.Promise,
                        p = t(l);
                    return r[e] = d, s.log(qq.format("Submitting Put Block request for {} = part {}", e, l)), a[e] = qq.format("{}&comp=block&blockid={}", u, encodeURIComponent(p)), o[e] = {
                        part: l,
                        id: p
                    }, n.initTransport(e).withPayload(c).send(i), d
                }
            })
            ...
            function t(e) {
                ...
                return e.sort(function(e, t) {
                    ...
                    var i = t.createElement("Latest"),
                        o = t.createTextNode(n.id);
            ...
            qq.extend(r, e), n = qq.extend(this, new qq.AjaxRequester({
                validMethods: [i],
                method: i,
                successfulResponseCodes: function() {
                    var e = {};
                ...
                onComplete: function(e, t, n) {
                    var i = o[e];
                    delete s[e], delete o[e], n ? i.failure(t) : i.success(t)
                }
            })), qq.extend(this, {
                method: i,
                send: function(e, i, a, u, l) {
                    var c, d = new qq.Promise,
                        p = t(a);
                    return o[e] = d, r.log(qq.format("Submitting Put Block List request for {}", e)), s[e] = qq.format("{}&comp=blocklist", i), c = n.initTransport(e).withPayload(p).withHeaders({
                        "x-ms-blob-content-type": u
                    }).send(), l(c), d
                }
            })
        },
