...
K && b.editable) { X(d, i, h.isStart); h.isEnd && v.resizableDayEvent(d, i, r) } 
            ...
            if (!b.disableDragging && i.draggable) {
                var p, l = true, u; i.draggable({ zIndex: 9, opacity: v.option("dragOpacity", "month"), revertDuration: b.dragRevertDuration, start: function (F, T) {
...
ja) { i.draggable("option", "revert", !S || !ea && !ja); x(); if (S) { u = ja * Y; if (S.row) { if (h && l) { Sa(i.width(r - 10), s * Math.round((d.end ? (d.end - d.start) / Hb : b.defaultEventMinutes) / b.slotMinutes)); i.draggable("option", "grid", [r, 1]); l = false } } else { N(C(q(d.start), u), C(Pa(d), u)); z() } } }, F, "drag")
            ...
            if (!b.disableDragging && i.draggable) {
                var p, l = false, u, z, F; i.draggable({ zIndex: 9, scroll: false, grid: [r, s], axis: m == 1 ? "y" : false, opacity: v.option("dragOpacity"), revertDuration: b.dragRevertDuration, start: function (V, ea) {
...
i.css("filter", "").find("span.fc-event-bg").css("display", ""); v.showEvents(d, i)
            ...
            if (!b.disableResizing && i.resizable) {
                var p, l; i.resizable({ handles: { s: "div.ui-resizable-s" }, grid: s, start: function (u, z) {
...
"")
    ...
    }, Mb = { header: { left: "next,prev today", center: "", right: "title" }, buttonText: { prev: "&nbsp;&#9658;&nbsp;", next: "&nbsp;&#9668;&nbsp;", prevYear: "&nbsp;&gt;&gt;&nbsp;",
        nextYear: "&nbsp;&lt;&lt;&nbsp;"
...
w() && k()
    ...
    } var O = this, ra = o(O).addClass("fc"), ka, R = o("<div class='fc-content " + g + "-widget-content' style='position:relative'/>").prependTo(O), va, Fa = 0, N = 0, L = new Date, Aa, x, U = {}, wa; a.isRTL && ra.addClass("fc-rtl"); a.theme && ra.addClass("ui-widget"); Cb(L, a.year, a.month, a.date); var P = [], la, A, aa = 0, Z = { render: function () { ga(); G(); M(); k() }, changeView: n, getView: function () { return x }, getDate: function () { return L }, option: function (e, j) {
...
r)
        ...
        return new Wa(a, b, { render: function (c, g) {
...
b); this.renderGrid(1, b.weekends ? 7 : 5, this.option("columnFormat"), false)
        ...
        return new ub(a, b, { render: function (c, g) {
            if (g) {
...
1)
    ...
    }; var lb = { init: function (a, b) { this.element = a; this.options = b; this.eventsByID = {}; this.eventElements = []; this.eventElementsByID = {}; this.usedOverlays = []; this.unusedOverlays = [] }, trigger: function (a, b) { if (this.options[a]) return this.options[a].apply(b || this, Array.prototype.slice.call(arguments, 2).concat([this])) }, eventEnd: function (a) {
        return a.end ?
...
-f, -c); k.rerenderEvents()
        ...
        var c = this; if (!c.options.disableResizing && b.resizable) b.resizable({ handles: c.options.isRTL ? { w: "div.ui-resizable-w"} : { e: "div.ui-resizable-e" }, grid: f, minWidth: f / 2, containment: c.element.parent().parent(), start: function (g, n) {
...
w, c)) M += k; k = t; break
    ...
    }, Ob = { s: function (a) { return a.getSeconds() }, ss: function (a) { return Na(a.getSeconds()) }, m: function (a) { return a.getMinutes() }, mm: function (a) { return Na(a.getMinutes()) }, h: function (a) { return a.getHours() % 12 || 12 }, hh: function (a) { return Na(a.getHours() % 12 || 12) }, H: function (a) { return a.getHours() }, HH: function (a) { return Na(a.getHours()) }, d: function (a) { return a.getDate() },
