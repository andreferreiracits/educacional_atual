...
this.op.vsakt = {i:9,f:10,o:12,s:5.1,n:20,c:16};
this.op.vsdefault = {i:7,f:8,o:10.1,s:3.2,n:10,c:16};
...
if (ll=="de")
    ...
    t = 'Atualize seu navegador para garantir o perfeito funcionamento desta p&aacute;gina.';
else if (ll=="sl")
