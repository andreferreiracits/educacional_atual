jQuery(function ($) {
    ...
    * Carrega Agenda
    ********************************************************************/
    if (url.indexOf("/perfil/home/index/") == -1) { //Se não for o perfil publico carrega
    ...
    /********************************************************************
    * Mouseover em eventos contínuos
    ********************************************************************/
    ...
    $('.avaJCalendario').live('click', function () {
        ...
        /**********************************************************************/
        //tira a selação do dia atual, e se for o dia atual, marca a seleção
        /**********************************************************************/
        este = $(this).parent();
    ...
    /**********************************************************************/
    //Verifica qual está selecionado no criar Agenda Escola ou Portal
    /**********************************************************************/
...
function validarEdicaoAgenda() {
    ...
    var objJsonAgenda;
	   ...
	   if ($dtmFim != "" && $dtmInicio != "") { // Se a data é preenchida, final deve ser maior, se vazio, passa
