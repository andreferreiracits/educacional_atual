...
var $buo = function (op, test) {
    ...
    var urlRedirecionamentoAux = "";
    this.op = op || {};
    //options
    this.op.l = op.l || n["language"] || n["userLanguage"] || document.documentElement.getAttribute("lang") || "en";
    this.op.vsakt = { i: 11, f: 10, o: 20, s: 5.1, n: 20, c: 16 };
    this.op.vsdefault = { i: 10, f: 8, o: 10.6, s: 3.2, n: 10, c: 16 };
    this.op.urlDefault = "/ava/erro/home/browserdesatualizado";
    this.op.vs = op.vs || this.op.vsdefault;
    for (b in this.op.vsakt)
        if (this.op.vs[b] >= this.op.vsakt[b])
            this.op.vs[b] = this.op.vsakt[b] - 0.05;

    if (!(this.op.urlRedirecionamento)) {
        urlRedirecionamentoAux = this.op.urlDefault;
    } else {
        urlRedirecionamentoAux = this.op.urlRedirecionamento;
    }
    ...
    */
    ...
    if (ll == "de")
        ...
        t = 'Atualize seu navegador para garantir o perfeito funcionamento desta p&aacute;gina. <a href="' + urlRedirecionamentoAux + '">Mais Informa&ccedil;&otilde;es</a>';
    else if (ll == "sl")
