...
jQuery(function ($) {
    $("#ava_barratopo").delegate(".action_secre", "click", function () {
        $('#main_ava').hide();
        var este = $(this);
        $.ajax({
    ...
    $('body').on("click", "#dropdown_dinamico .action_secre", function (e) {
        //$("#dropdown_dinamico").delegate(".action_secre", "click", function () {
    ...
    $("#ava_wrap").delegate(".action_administracao", "click", function () {
