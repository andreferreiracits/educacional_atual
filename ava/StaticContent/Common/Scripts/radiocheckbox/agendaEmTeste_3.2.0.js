...
function validarEdicaoNovaAgenda() {
    ...
    if (s.length > 500) {
        $("#msgErroCriarAgenda").show();
        $("#msgErroCriarAgenda span:last").empty().text("Título inválido - Máximo 500 caracteres.");
        $("input.btn_laranja.salvar").val("Salvar");
        $("input.btn_laranja.salvar").removeAttr("disabled");
        return false
    }
...
function validarEdicaoAgenda() {
    ...
    if ($txtTexto.length > 500) {
        alert("Título inválido - Máximo 500 caracteres.");
        return false
    }
...
// function VerficaQuantasAtividadesSaoIguaisAquelaData(data,listaAtividadesParaAgendar){
//     var dataInicial = new Date(  listaAtividadesParaAgendar.Result.dtmInicio  );
//     return   dataInicial  == data : 
// }
