...
function logoutAVA() {
    ...
    // location.href = "/home_andre/"

    // $.ajax({

    //     url: "/AVA/Login/Home/LogoutSchool",
    //     async: true,
    //     contentType: "application/x-www-form-urlencoded; charset=UTF-8",
...
function abrirTermoUso(){
    var flagContinua = true;
    $.fancybox.showLoading();
    $.ajax({
        url: "/termos/pop_termos2.asp",
        type: "GET",
        dataType: "html",
        async: !1,//false,
        success: function (data) {
            //$("#previewTemoUso").html("<a href='javascript:void(0);' class='btn_cinza left' id='btn_cancelarGeral'>Fechar</a>")
            $("#previewTemoUso").append(data);
...
function fecharModal(){
    window.close();
    window.parent.$('#previewTemoUso').dialog('close');
}
