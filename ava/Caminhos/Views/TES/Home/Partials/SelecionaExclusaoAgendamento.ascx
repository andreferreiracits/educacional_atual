...
<div class="excluir_agendamento">
    ...
    <div class="ava_lightheader"><h2 class="blokletters"> Excluir agendamento</h2></div>
    <div class="ava_lightcontainer clearfix">
        ...
        <div class="light_bts">
            <a class="large awesome awesome-color " href="javascript: void(0);" id="btExcAgendamento"><span></span>Excluir Agendamento </a>
            <a class="large awesome c-cancelar" href="javascript: void(0);" id="btCancelarAgendamento"><span class="awe_icons"></span>Cancelar </a>  
        </div>
    </div>
