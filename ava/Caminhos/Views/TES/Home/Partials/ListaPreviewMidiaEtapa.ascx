    ...
    case 1:
        {//Youtube 
            if (!String.IsNullOrEmpty(tempo))
                tempo = "&start=" + tempo;
            embed = "<iframe width=\"" + larguraVideo + "\" height=\"" + alturaVideo + "\" src=\"http://www.youtube.com/embed/" + idMidia + "?autoplay=0&wmode=transparent" + tempo + "\" frameborder=\"0\" allowfullscreen></iframe>";
        } break;
    case 2:
        { //Vimeo
            if (!String.IsNullOrEmpty(tempo))
                tempo = "?player_id=previewMidia&api=1#t=" + tempo;
            embed = "<iframe class=\"iframeVideoVimeo\" src=\"http://player.vimeo.com/video/" + idMidia + tempo + "\" width=\"" + larguraVideo + "\" height=\"" + alturaVideo + "\" frameborder=\"0\" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>";
        } break;
    case 3:
        { //Globo
