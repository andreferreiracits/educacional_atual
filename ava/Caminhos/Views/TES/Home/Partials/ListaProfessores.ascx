<%@ Control Language="C#" Debug="true" Inherits="System.Web.Mvc.ViewUserControl<System.Collections.Generic.IList<UsuarioAVA.Models.Usuario>>" %>
...
if (qtd > 0)
{
    ...
    foreach (var usuarios in Model.lUsuarioAgendamento)
    {
       ...
       <span class="ta_alunos_ft <%=strClassAdd%>">
            ...
            {
                %>
                <img id="<%=usuarios.id%>" src="<%=usuarios.strMiniFoto%>" class="b_tooltip_center" width="33" height="33" style="cursor: default;">
                <% 
            }
            %>
