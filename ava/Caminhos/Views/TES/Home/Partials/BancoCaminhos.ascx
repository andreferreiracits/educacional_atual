                ...
                <div id="filtro_aval" class="clearfix">
                    ...
                    <div id="conteudo_filtro">
                        ...
                        <div class="f_aval lista">  
        					...
        					<div> 
        						<input type="checkbox" checked="checked" value="1" id="comp_escola" name="statuspesquisa_cam"/>
        						<label for="comp_escola"> Compartilhado</label>
        					</div>
                            <div>
        						<input type="checkbox" checked="checked" value="2" id="privado" name="statuspesquisa_cam"/>
                            ...
                            %>
                            <div>
        						<input type="checkbox" value="3" id="comp_portal" name="statuspesquisa_cam"/>
        						<label for="comp_portal"> Compartilhado para o POL</label>
        					</div>
                                <div>
        						<input type="checkbox" value="4" id="revisao" name="statuspesquisa_cam"/>
                        ...
                        <div class="f_aval_bts">
                            ...
                            <a class="btn_cor color" onclick="filtrarCaminho();" href="javascript: void(0);">Filtrar</a>  
                            <a class="btn_cinza" onclick="limparfiltroCaminho();" href="javascript: void(0);">Limpar</a>                       
                        </div>
                ...
                <div class="le_filtros">
                    ...
                    <div class="lajotinhas">
                        ...
                        <ul class="lajotinha_filtro">                            
                            <li id="1"><span class="lajotinha">Meus<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(1,1,1)"></a></span></span></li>
                            <% if(!bolAdmRede && !ehPOL){ %>
                            <li id="2"><span class="lajotinha">Escola<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(2,1,2)"></a></span></span></li>
                            <%} %>
                            <%  if (Convert.ToInt32(ViewData["bolAVAPuro"]) == 0)
                                { %>
                            <li id="3"><span class="lajotinha">Portal<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(3,1,3)"></a></span></span></li>
                            <%} %>
                            <%  
                            if (ehPOL && !bolAdmRede)
                            {
                                %>
                                <li id="5"><span class="lajotinha">Compartilhado para POL<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(5,2,6)"></a></span></span></li>
                                <li id="6"><span class="lajotinha">Em revisão<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(6,3,6)"></a></span></span></li>
                                <%
                            }
                            %>
                            <li id="4"><span class="lajotinha">Compartilhado<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(4,1,6)"></a></span></span></li>
                            <li id="7"><span class="lajotinha">Privado<span class="lajo_x FontAwesome"><a href="javascript: void(0);" onclick="excluirFiltroCaminho(7,4,6)"></a></span></span></li>
                        </ul>
                        <div id="le_filtros_pesquisaUsuario">
                        </div>
                    </div>
