...
<article class="clearfix <%if(Model.bolEducador){%>  highlight <%} %>" id="avaMsg_<%=idMensagemRapida %>" ide="<%=idMensagemRapida%>" >
    ...
    <ul class="combo_denunciar_excluir">
        <li>
            ...
            <ul>                
                <li><a class="excluir_mensagem mostra_caixa confirma_excluir fancybox.ajax" href="/ava/mural/Home/excluirMensagem/<%:idMensagemRapida%>" ident="<%:idMensagemRapida%>"><span class="excluir_comentario_combo FontAwesome"></span>Excluir</a></li>
            </ul>                            
        </li>
    </ul>
    ...
    <div class="e-wrap">
        <h1>
            ...
            {   
                %>    
                <span class="mural_context">»</span> <a href="/AVA/Perfil/Home/Index/<%=Model.strLoginUsuarioDestino%>" class=""><%=Model.strNomeUsuarioDestino%></a>
                <%                   
            }
            %>
        </h1>
        ...
        if (Model.strLinkVideo.Length > 0)
        {
            ...
            %>
            <a href="<%=Model.strLinkVideo%>" target="_blank"><%=Model.strLinkVideo%></a>
