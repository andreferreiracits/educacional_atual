                                ...
                                <%if (Model.intCurtidas > 3)
                                  {%>
                                    <%if (Model.intCurtidas == 4)
                                      {%>
                                        e mais <a href="/AVA/Barras/Home/RetornaViewPerseguicaoCompleta/?deonde=5&id=<%=Model.IdMensagemrapida%>" class="invert quem_gostou_msg">uma pessoa</a> 
                                    <%} %>
                                    <%if (Model.intCurtidas > 4)
                                      {%>
                                        e mais <a href="/AVA/Barras/Home/RetornaViewPerseguicaoCompleta/?deonde=5&id=<%=Model.IdMensagemrapida%>" class="invert quem_gostou_msg"><%:(Model.intCurtidas - 3)%> pessoas</a>  
                                    <%} %>
                                <%} %>
