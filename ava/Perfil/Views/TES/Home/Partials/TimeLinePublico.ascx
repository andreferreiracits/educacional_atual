<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Perfil.Models.MainPerfilPublico>" %>
    ...
    %>
        ...
        <article class="clearfix" id="avaMsg_<%=idMensagemRapida %>">            
           <img class="avatar_tl" src="http://www.educacional.com.br<%=item.strMiniFoto %>" width="55" height="55" alt="avatar">
                     
            <div class="embrulho">
                <h1><a href="#" title="persona" alt="persona"  class=""><%=item.strNome%></a> </h1>
                <p class="ctn_msg"><%=item.StrMensagem%></p>
                    <p class="discreto"><%=linkCompartilhamento %><%=item.strTempoPublicacao%> <a href="#" title="persona" alt="persona"  class="">gostei</a></p>
