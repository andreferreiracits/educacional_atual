<%@ Page Language="C#" MasterPageFile="~/Views/TES/Shared/AcessoRapido.Master" Inherits="PositivoFramework.Web.Mvc.Theme.ThemedViewPage<Perfil.Models.AcessoRapidoList>" %>
    ...
    <script type="text/javascript" defer="defer" >
        jQuery(function () {
            $('.item_acessoRapido').click(function () {
                var id = $(this).attr('id');                
                $.ajax({
                    url: "/AVA/Perfil/AcessoRapido/GravaContAcesso/?idAcessoRapido=" + id            
                }).css('cursor','pointer');
            });
        });
    </script>
